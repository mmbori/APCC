...
*/
int fts3tokConnectMethod(sqlite3 *db, void *pHash, int argc,
...
*/
int fts3tokFilterMethod(sqlite3_vtab_cursor *pCursor, int idxNum,
...
*/
int fts3tokColumnMethod(sqlite3_vtab_cursor *pCursor, sqlite3_context *pCtx,
                        int iCol){
  Fts3tokCursor *pCsr = (Fts3tokCursor *)pCursor;
...
int sqlite3Fts3InitTok(sqlite3 *db, Fts3Hash *pHash, void(*xDestroy)(void*)){
  static const sqlite3_module fts3tok_module = {
     ...
     0                            /* xIntegrity    */
  ,
  .xCreate_signature = xCreate_fts3tokConnectMethod,
  .xConnect_signature = xConnect_fts3tokConnectMethod,
  .xBestIndex_signature = xBestIndex_fts3tokBestIndexMethod,
  .xDisconnect_signature = xDisconnect_fts3tokDisconnectMethod,
  .xDestroy_signature = xDestroy_fts3tokDisconnectMethod,
  .xOpen_signature = xOpen_fts3tokOpenMethod,
  .xClose_signature = xClose_fts3tokCloseMethod,
  .xFilter_signature = xFilter_fts3tokFilterMethod,
  .xNext_signature = xNext_fts3tokNextMethod,
  .xEof_signature = xEof_fts3tokEofMethod,
  .xColumn_signature = xColumn_fts3tokColumnMethod,
  .xRowid_signature = xRowid_fts3tokRowidMethod,
