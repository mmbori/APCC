...
int PredictorSetupDecode(TIFF *tif)
{
    ...
    if (sp->predictor == 2)
    {
        switch (td->td_bitspersample)
        {
            case 8:
                ...
                sp->decodepfunc_signature = decodepfunc_horAcc8;
                break;
            case 16:
                sp->decodepfunc = horAcc16;
                sp->decodepfunc_signature = decodepfunc_horAcc16;
                break;
            case 32:
                sp->decodepfunc = horAcc32;
                sp->decodepfunc_signature = decodepfunc_horAcc32;
                break;
            case 64:
                sp->decodepfunc = horAcc64;
                sp->decodepfunc_signature = decodepfunc_horAcc64;
                break;
        }
        /*
        ...
        if (tif->tif_decoderow != PredictorDecodeRow)
        {
            ...
            tif->tif_decoderow_signature = tif_decoderow_PredictorDecodeRow;
            sp->decodestrip = tif->tif_decodestrip;
            tif->tif_decodestrip = PredictorDecodeTile;
            tif->tif_decodestrip_signature = tif_decodestrip_PredictorDecodeTile;
            sp->decodetile = tif->tif_decodetile;
            tif->tif_decodetile = PredictorDecodeTile;
            tif->tif_decodetile_signature = tif_decodetile_PredictorDecodeTile;
        }
        ...
        if (tif->tif_flags & TIFF_SWAB)
        {
            if (sp->decodepfunc == horAcc16)
            {
                ...
                sp->decodepfunc_signature = decodepfunc_swabHorAcc16;
            ...
            else if (sp->decodepfunc == horAcc32)
            {
                ...
                sp->decodepfunc_signature = decodepfunc_swabHorAcc32;
                tif->tif_postdecode = _TIFFNoPostDecode;
                tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
            }
            else if (sp->decodepfunc == horAcc64)
            {
                ...
                sp->decodepfunc_signature = decodepfunc_swabHorAcc64;
                tif->tif_postdecode = _TIFFNoPostDecode;
                tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
            }
        }
    ...
    else if (sp->predictor == 3)
    {
        ...
        sp->decodepfunc_signature = decodepfunc_fpAcc;
        /*
         * Override default decoding method with one that does the
         * predictor stuff.
         */
...
int PredictorSetupEncode(TIFF *tif)
{
    ...
    if (sp->predictor == 2)
    {
        switch (td->td_bitspersample)
        {
            case 8:
                ...
                sp->encodepfunc_signature = encodepfunc_horDiff8;
                break;
            case 16:
                sp->encodepfunc = horDiff16;
                sp->encodepfunc_signature = encodepfunc_horDiff16;
                break;
            case 32:
                sp->encodepfunc = horDiff32;
                sp->encodepfunc_signature = encodepfunc_horDiff32;
                break;
            case 64:
                sp->encodepfunc = horDiff64;
                sp->encodepfunc_signature = encodepfunc_horDiff64;
                break;
        }
        /*
        ...
        if (tif->tif_encoderow != PredictorEncodeRow)
        {
            ...
            tif->tif_encoderow_signature = tif_encoderow_PredictorEncodeRow;
            sp->encodestrip = tif->tif_encodestrip;
            tif->tif_encodestrip = PredictorEncodeTile;
            tif->tif_encodestrip_signature = tif_encodestrip_PredictorEncodeTile;
            sp->encodetile = tif->tif_encodetile;
            tif->tif_encodetile = PredictorEncodeTile;
            tif->tif_encodetile_signature = tif_encodetile_PredictorEncodeTile;
        }
        ...
        if (tif->tif_flags & TIFF_SWAB)
        {
            if (sp->encodepfunc == horDiff16)
            {
                ...
                sp->encodepfunc_signature = encodepfunc_swabHorDiff16;
                tif->tif_postdecode = _TIFFNoPostDecode;
                tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
            }
            else if (sp->encodepfunc == horDiff32)
            {
                ...
                sp->encodepfunc_signature = encodepfunc_swabHorDiff32;
                tif->tif_postdecode = _TIFFNoPostDecode;
                tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
            }
            else if (sp->encodepfunc == horDiff64)
            {
                ...
                sp->encodepfunc_signature = encodepfunc_swabHorDiff64;
                tif->tif_postdecode = _TIFFNoPostDecode;
                tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
            }
        }
    ...
    else if (sp->predictor == 3)
    {
        ...
        sp->encodepfunc_signature = encodepfunc_fpDiff;
        /*
         * Override default encoding method with one that does the
         * predictor stuff.
         */
...
int PredictorVGetField(TIFF *tif, uint32_t tag, va_list ap)
{
    ...
    if (tag == TIFFTAG_PREDICTOR) {
        *va_arg(ap, uint16_t *) = (uint16_t)sp->predictor;
        ...
        switch (sp->vgetparent_signature) {
            case vgetfield_Fax3VGetField:
                return Fax3VGetField(tif, tag, ap);
                break;
            case vgetfield_LogLuvVGetField:
                return LogLuvVGetField(tif, tag, ap);
                break;
            case vgetfield_PixarLogVGetField:
                return PixarLogVGetField(tif, tag, ap);
                break;
            case vgetfield_PredictorVGetField:
                return PredictorVGetField(tif, tag, ap);
                break;
            case vgetfield_ZIPVGetField:
                return ZIPVGetField(tif, tag, ap);
                break;
            case vgetfield__TIFFVGetField:
                return _TIFFVGetField(tif, tag, ap);
                break;
            default:
...
int TIFFPredictorInit(TIFF *tif)
{
    ...
    sp->vgetparent_signature = tif->tif_tagmethods.vgetfield_signature;
    tif->tif_tagmethods.vgetfield = PredictorVGetField;
    tif->tif_tagmethods.vgetfield_signature = vgetfield_PredictorVGetField; /* hook for predictor tag */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = PredictorVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_PredictorVSetField; /* hook for predictor tag */
    sp->printdir = tif->tif_tagmethods.printdir;
    tif->tif_tagmethods.printdir = PredictorPrintDir;
    tif->tif_tagmethods.printdir_signature = printdir_PredictorPrintDir; /* hook for predictor tag */

    sp->setupdecode = tif->tif_setupdecode;
    tif->tif_setupdecode = PredictorSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_PredictorSetupDecode;
    sp->setupencode = tif->tif_setupencode;
    tif->tif_setupencode = PredictorSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_PredictorSetupEncode;
...
int TIFFPredictorCleanup(TIFF *tif)
{
    ...
    tif->tif_tagmethods.printdir_signature = sp->printdir_signature;
    tif->tif_setupdecode = sp->setupdecode;
    tif->tif_setupdecode_signature = sp->setupdecode_signature;
    tif->tif_setupencode = sp->setupencode;
    tif->tif_setupencode_signature = sp->setupencode_signature;
