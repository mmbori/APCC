...
int TIFFInitJBIG(TIFF *tif, int scheme)
{
    ...
    tif->tif_setupdecode_signature = tif_setupdecode_JBIGSetupDecode;
    tif->tif_decodestrip = JBIGDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_JBIGDecode;

    tif->tif_setupencode = JBIGSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_JBIGSetupEncode;
    tif->tif_encodestrip = JBIGEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_JBIGEncode;
