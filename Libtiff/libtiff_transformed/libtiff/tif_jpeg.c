...
typedef struct
{
    ...
    uint32_t (*defsparent)(TIFF *, uint32_t); /* super-class method */
    void (*deftparent)(TIFF *, uint32_t *, uint32_t *);  /* super-class method */
    ...
    int defsparent_signature;
    int deftparent_signature;
} JPEGOtherSettings;
...
int JPEGSetupDecode(TIFF *tif)
{
    ...
    tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode; /* override byte swapping */
    return (1);
}
 ...
 */
/*ARGSUSED*/ int JPEGPreDecode(TIFF *tif, uint16_t s)
{
    JPEGState *sp = JState(tif);
    TIFFDirectory *td = &tif->tif_dir;
    ...
    if (downsampled_output)
    {
        ...
        tif->tif_decoderow_signature = tif_decoderow_DecodeRowError;
        tif->tif_decodestrip = JPEGDecodeRaw;
        tif->tif_decodestrip_signature = tif_decodestrip_JPEGDecodeRaw;
        tif->tif_decodetile = JPEGDecodeRaw;
        tif->tif_decodetile_signature = tif_decodetile_JPEGDecodeRaw;
    }
    else
    {
        ...
        tif->tif_decoderow_signature = tif_decoderow_JPEGDecode;
        tif->tif_decodestrip = JPEGDecode;
        tif->tif_decodestrip_signature = tif_decodestrip_JPEGDecode;
        tif->tif_decodetile = JPEGDecode;
        tif->tif_decodetile_signature = tif_decodetile_JPEGDecode;
    }
...
#if JPEG_LIB_MK1_OR_12BIT
/*ARGSUSED*/ int JPEGDecode(TIFF *tif, uint8_t *buf, tmsize_t cc, uint16_t s)
{
    JPEGState *sp = JState(tif);
    tmsize_t nrows;
    (void)s;
...
/*ARGSUSED*/ int DecodeRowError(TIFF *tif, uint8_t *buf, tmsize_t cc,
                                uint16_t s)
 ...
 */
/*ARGSUSED*/ int JPEGDecodeRaw(TIFF *tif, uint8_t *buf, tmsize_t cc,
                               uint16_t s)
{
    JPEGState *sp = JState(tif);
    tmsize_t nrows;
...
int JPEGPreEncode(TIFF *tif, uint16_t s)
{
    ...
    if (downsampled_input)
    {
        ...
        tif->tif_encoderow_signature = tif_encoderow_JPEGEncodeRaw;
        tif->tif_encodestrip = JPEGEncodeRaw;
        tif->tif_encodestrip_signature = tif_encodestrip_JPEGEncodeRaw;
        tif->tif_encodetile = JPEGEncodeRaw;
        tif->tif_encodetile_signature = tif_encodetile_JPEGEncodeRaw;
    }
    else
    {
        /* Use normal interface to libjpeg */
        ...
        tif->tif_encoderow_signature = tif_encoderow_JPEGEncode;
        tif->tif_encodestrip = JPEGEncode;
        tif->tif_encodestrip_signature = tif_encodestrip_JPEGEncode;
        tif->tif_encodetile = JPEGEncode;
        tif->tif_encodetile_signature = tif_encodetile_JPEGEncode;
    }
...
static void TIFFInitJPEGCommon(TIFF *tif)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_JPEGVGetField; /* hook for codec tags */
    tif->tif_tagmethods.vsetfield = JPEGVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_JPEGVSetField; /* hook for codec tags */
    tif->tif_tagmethods.printdir = JPEGPrintDir;
    tif->tif_tagmethods.printdir_signature = printdir_JPEGPrintDir;   /* hook for codec tags */

    /*
     * Install codec methods.
     */
    tif->tif_fixuptags = JPEGFixupTags;
    tif->tif_fixuptags_signature = tif_fixuptags_JPEGFixupTags;
    tif->tif_setupdecode = JPEGSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_JPEGSetupDecode;
    tif->tif_predecode = JPEGPreDecode;
    tif->tif_predecode_signature = tif_predecode_JPEGPreDecode;
    tif->tif_decoderow = JPEGDecode;
    tif->tif_decoderow_signature = tif_decoderow_JPEGDecode;
    tif->tif_decodestrip = JPEGDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_JPEGDecode;
    ...
    tif->tif_setupencode_signature = tif_setupencode_JPEGSetupEncode;
    tif->tif_preencode = JPEGPreEncode;
    tif->tif_preencode_signature = tif_preencode_JPEGPreEncode;
    tif->tif_postencode = JPEGPostEncode;
    tif->tif_postencode_signature = tif_postencode_JPEGPostEncode;
    tif->tif_encoderow = JPEGEncode;
    tif->tif_encoderow_signature = tif_encoderow_JPEGEncode;
    tif->tif_encodestrip = JPEGEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_JPEGEncode;
    ...
    tif->tif_cleanup_signature = tif_cleanup_JPEGCleanup;

    tif->tif_defstripsize = JPEGDefaultStripSize;
    tif->tif_defstripsize_signature = tif_defstripsize_JPEGDefaultStripSize;
    tif->tif_deftilesize = JPEGDefaultTileSize;
    tif->tif_deftilesize_signature = tif_deftilesize_JPEGDefaultTileSize;
