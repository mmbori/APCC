...
int LogL16Decode(TIFF *tif, uint8_t *op, tmsize_t occ, uint16_t s)
{
    ...
    switch (sp->tfunc_signature) {
    case tfunc_L16fromY:
        L16fromY(sp, op, npixels);
        break;
    case tfunc_L16toGry:
        L16toGry(sp, op, npixels);
        break;
    case tfunc_L16toY:
        L16toY(sp, op, npixels);
        break;
    case tfunc_Luv24fromLuv48:
        Luv24fromLuv48(sp, op, npixels);
        break;
    case tfunc_Luv24fromXYZ:
        Luv24fromXYZ(sp, op, npixels);
        break;
    case tfunc_Luv24toLuv48:
        Luv24toLuv48(sp, op, npixels);
        break;
    case tfunc_Luv24toRGB:
        Luv24toRGB(sp, op, npixels);
        break;
    case tfunc_Luv24toXYZ:
        Luv24toXYZ(sp, op, npixels);
        break;
    case tfunc_Luv32fromLuv48:
        Luv32fromLuv48(sp, op, npixels);
        break;
    case tfunc_Luv32fromXYZ:
        Luv32fromXYZ(sp, op, npixels);
        break;
    case tfunc_Luv32toLuv48:
        Luv32toLuv48(sp, op, npixels);
        break;
    case tfunc_Luv32toRGB:
        Luv32toRGB(sp, op, npixels);
        break;
    case tfunc_Luv32toXYZ:
        Luv32toXYZ(sp, op, npixels);
        break;
    case tfunc__logLuvNop:
        _logLuvNop(sp, op, npixels);
        break;
    default:
...
int LogLuvDecodeStrip(TIFF *tif, uint8_t *bp, tmsize_t cc, uint16_t s)
{
    ...
    case tif_decoderow_DumpModeDecode:
        tmp = DumpModeDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_Fax3Decode1D:
        tmp = Fax3Decode1D(tif, bp, rowlen, s);
        break;
    case tif_decoderow_Fax3Decode2D:
        tmp = Fax3Decode2D(tif, bp, rowlen, s);
        break;
    case tif_decoderow_Fax3DecodeRLE:
        tmp = Fax3DecodeRLE(tif, bp, rowlen, s);
        break;
    case tif_decoderow_Fax4Decode:
        tmp = Fax4Decode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_LZWDecode:
        tmp = LZWDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_LZWDecodeCompat:
        tmp = LZWDecodeCompat(tif, bp, rowlen, s);
        break;
    case tif_decoderow_LogL16Decode:
        tmp = LogL16Decode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_LogLuvDecode24:
        tmp = LogLuvDecode24(tif, bp, rowlen, s);
        break;
    case tif_decoderow_LogLuvDecode32:
        tmp = LogLuvDecode32(tif, bp, rowlen, s);
        break;
    case tif_decoderow_NeXTDecode:
        tmp = NeXTDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_PackBitsDecode:
        tmp = PackBitsDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_PixarLogDecode:
        tmp = PixarLogDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow_PredictorDecodeRow:
        tmp = PredictorDecodeRow(tif, bp, rowlen, s);
        break;
    case tif_decoderow_ThunderDecodeRow:
        tmp = ThunderDecodeRow(tif, bp, rowlen, s);
        break;
    case tif_decoderow_ZIPDecode:
        tmp = ZIPDecode(tif, bp, rowlen, s);
        break;
    case tif_decoderow__TIFFNoRowDecode:
        tmp = _TIFFNoRowDecode(tif, bp, rowlen, s);
        break;
    default:
        invalidFunctionWasCalled();
        break;
...
int LogL16Encode(TIFF *tif, uint8_t *bp, tmsize_t cc, uint16_t s)
{
    ...
    else
    {
        ...
        switch (sp->tfunc_signature) {
    case tfunc_L16fromY:
        L16fromY(sp, bp, npixels);
        break;
    case tfunc_L16toGry:
        L16toGry(sp, bp, npixels);
        break;
    case tfunc_L16toY:
        L16toY(sp, bp, npixels);
        break;
    case tfunc_Luv24fromLuv48:
        Luv24fromLuv48(sp, bp, npixels);
        break;
    case tfunc_Luv24fromXYZ:
        Luv24fromXYZ(sp, bp, npixels);
        break;
    case tfunc_Luv24toLuv48:
        Luv24toLuv48(sp, bp, npixels);
        break;
    case tfunc_Luv24toRGB:
        Luv24toRGB(sp, bp, npixels);
        break;
    case tfunc_Luv24toXYZ:
        Luv24toXYZ(sp, bp, npixels);
        break;
    case tfunc_Luv32fromLuv48:
        Luv32fromLuv48(sp, bp, npixels);
        break;
    case tfunc_Luv32fromXYZ:
        Luv32fromXYZ(sp, bp, npixels);
        break;
    case tfunc_Luv32toLuv48:
        Luv32toLuv48(sp, bp, npixels);
        break;
    case tfunc_Luv32toRGB:
        Luv32toRGB(sp, bp, npixels);
        break;
    case tfunc_Luv32toXYZ:
        Luv32toXYZ(sp, bp, npixels);
        break;
    case tfunc__logLuvNop:
        _logLuvNop(sp, bp, npixels);
        break;
    default:
        invalidFunctionWasCalled();
        break;
...
int LogLuvEncodeStrip(TIFF *tif, uint8_t *bp, tmsize_t cc, uint16_t s)
{
    ...
    int tmp3;
    switch (tif->tif_encoderow_signature) {
    case tif_encoderow_DumpModeEncode:
        tmp3 = DumpModeEncode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_Fax3Encode:
        tmp3 = Fax3Encode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_Fax4Encode:
        tmp3 = Fax4Encode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_LZWEncode:
        tmp3 = LZWEncode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_LogL16Encode:
        tmp3 = LogL16Encode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_LogLuvEncode24:
        tmp3 = LogLuvEncode24(tif, bp, rowlen, s);
        break;
    case tif_encoderow_LogLuvEncode32:
        tmp3 = LogLuvEncode32(tif, bp, rowlen, s);
        break;
    case tif_encoderow_PackBitsEncode:
        tmp3 = PackBitsEncode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_PixarLogEncode:
        tmp3 = PixarLogEncode(tif, bp, rowlen, s);
        break;
    case tif_encoderow_PredictorEncodeRow:
        tmp3 = PredictorEncodeRow(tif, bp, rowlen, s);
        break;
    case tif_encoderow_ZIPEncode:
        tmp3 = ZIPEncode(tif, bp, rowlen, s);
        break;
    case tif_encoderow__TIFFNoRowEncode:
        tmp3 = _TIFFNoRowEncode(tif, bp, rowlen, s);
        break;
    default:
        invalidFunctionWasCalled();
        break;
...
int LogLuvSetupDecode(TIFF *tif)
{
    ...
    tif->tif_postdecode_signature = tif_postdecode__TIFFNoPostDecode;
    switch (td->td_photometric)
    {
        case PHOTOMETRIC_LOGLUV:
            ...
            if (td->td_compression == COMPRESSION_SGILOG24)
            {
                ...
                tif->tif_decoderow_signature = tif_decoderow_LogLuvDecode24;
                switch (sp->user_datafmt)
                {
                    case SGILOGDATAFMT_FLOAT:
                        sp->tfunc = Luv24toXYZ;
                        sp->tfunc_signature = tfunc_Luv24toXYZ;
                        break;
                    case SGILOGDATAFMT_16BIT:
                        sp->tfunc = Luv24toLuv48;
                        sp->tfunc_signature = tfunc_Luv24toLuv48;
                        break;
                    case SGILOGDATAFMT_8BIT:
                        sp->tfunc = Luv24toRGB;
                        sp->tfunc_signature = tfunc_Luv24toRGB;
                        break;
                }
            }
            else
            {
                ...
                tif->tif_decoderow_signature = tif_decoderow_LogLuvDecode32;
                switch (sp->user_datafmt)
                {
                    case SGILOGDATAFMT_FLOAT:
                        sp->tfunc = Luv32toXYZ;
                        sp->tfunc_signature = tfunc_Luv32toXYZ;
                        break;
                    case SGILOGDATAFMT_16BIT:
                        sp->tfunc = Luv32toLuv48;
                        sp->tfunc_signature = tfunc_Luv32toLuv48;
                        break;
                    case SGILOGDATAFMT_8BIT:
                        sp->tfunc = Luv32toRGB;
                        sp->tfunc_signature = tfunc_Luv32toRGB;
                        break;
                }
            }
            return (1);
        case PHOTOMETRIC_LOGL:
            ...
            tif->tif_decoderow_signature = tif_decoderow_LogL16Decode;
            switch (sp->user_datafmt)
            {
                case SGILOGDATAFMT_FLOAT:
                    sp->tfunc = L16toY;
                    sp->tfunc_signature = tfunc_L16toY;
                    break;
                case SGILOGDATAFMT_8BIT:
                    sp->tfunc = L16toGry;
                    sp->tfunc_signature = tfunc_L16toGry;
                    break;
            }
            return (1);
        default:
    ...
    switch (td->td_photometric)
    {
        case PHOTOMETRIC_LOGLUV:
            ...
            if (td->td_compression == COMPRESSION_SGILOG24)
            {
                ...
                tif->tif_encoderow_signature = tif_encoderow_LogLuvEncode24;
                switch (sp->user_datafmt)
                {
                    case SGILOGDATAFMT_FLOAT:
                        sp->tfunc = Luv24fromXYZ;
                        sp->tfunc_signature = tfunc_Luv24fromXYZ;
                        break;
                    case SGILOGDATAFMT_16BIT:
                        sp->tfunc = Luv24fromLuv48;
                        sp->tfunc_signature = tfunc_Luv24fromLuv48;
                        break;
                    case SGILOGDATAFMT_RAW:
                        break;
                    default:
            ...
            else
            {
                ...
                tif->tif_encoderow_signature = tif_encoderow_LogLuvEncode32;
                switch (sp->user_datafmt)
                {
                    case SGILOGDATAFMT_FLOAT:
                        sp->tfunc = Luv32fromXYZ;
                        sp->tfunc_signature = tfunc_Luv32fromXYZ;
                        break;
                    case SGILOGDATAFMT_16BIT:
                        sp->tfunc = Luv32fromLuv48;
                        sp->tfunc_signature = tfunc_Luv32fromLuv48;
                        break;
                    case SGILOGDATAFMT_RAW:
                        break;
                    default:
        ...
        case PHOTOMETRIC_LOGL:
            ...
            tif->tif_encoderow_signature = tif_encoderow_LogL16Encode;
            switch (sp->user_datafmt)
            {
                case SGILOGDATAFMT_FLOAT:
                    sp->tfunc = L16fromY;
                    sp->tfunc_signature = tfunc_L16fromY;
                    break;
                case SGILOGDATAFMT_16BIT:
                    break;
                default:
...
void LogLuvCleanup(TIFF *tif)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = sp->vgetparent_signature;
    tif->tif_tagmethods.vsetfield = sp->vsetparent;
    tif->tif_tagmethods.vsetfield_signature = sp->vsetparent_signature;
...
int TIFFInitSGILog(TIFF *tif, int scheme)
{
    ...
    sp->tfunc = _logLuvNop;
    sp->tfunc_signature = tfunc__logLuvNop;
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_LogLuvFixupTags;
    tif->tif_setupdecode = LogLuvSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_LogLuvSetupDecode;
    tif->tif_decodestrip = LogLuvDecodeStrip;
    tif->tif_decodestrip_signature = tif_decodestrip_LogLuvDecodeStrip;
    tif->tif_decodetile = LogLuvDecodeTile;
    tif->tif_decodetile_signature = tif_decodetile_LogLuvDecodeTile;
    tif->tif_setupencode = LogLuvSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_LogLuvSetupEncode;
    tif->tif_encodestrip = LogLuvEncodeStrip;
    tif->tif_encodestrip_signature = tif_encodestrip_LogLuvEncodeStrip;
    tif->tif_encodetile = LogLuvEncodeTile;
    tif->tif_encodetile_signature = tif_encodetile_LogLuvEncodeTile;
    tif->tif_close = LogLuvClose;
    tif->tif_close_signature = tif_close_LogLuvClose;
    tif->tif_cleanup = LogLuvCleanup;
    tif->tif_cleanup_signature = tif_cleanup_LogLuvCleanup;
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_LogLuvVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = LogLuvVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_LogLuvVSetField; /* hook for codec tags */
