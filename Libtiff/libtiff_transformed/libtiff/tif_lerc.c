...
int TIFFInitLERC(TIFF *tif, int scheme)
{
    ...
    tif->tif_tagmethods.vgetfield = LERCVGetField;
    tif->tif_tagmethods.vgetfield_signature = vgetfield_LERCVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = LERCVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_LERCVSetField; /* hook for codec tags */

    /*
     * Install codec methods.
     */
    tif->tif_fixuptags = LERCFixupTags;
    tif->tif_fixuptags_signature = tif_fixuptags_LERCFixupTags;
    tif->tif_setupdecode = LERCSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_LERCSetupDecode;
    tif->tif_predecode = LERCPreDecode;
    tif->tif_predecode_signature = tif_predecode_LERCPreDecode;
    tif->tif_decoderow = LERCDecode;
    tif->tif_decoderow_signature = tif_decoderow_LERCDecode;
    tif->tif_decodestrip = LERCDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_LERCDecode;
    tif->tif_decodetile = LERCDecode;
    tif->tif_decodetile_signature = tif_decodetile_LERCDecode;
#ifndef LERC_READ_ONLY
    tif->tif_setupencode = LERCSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_LERCSetupEncode;
    tif->tif_preencode = LERCPreEncode;
    tif->tif_preencode_signature = tif_preencode_LERCPreEncode;
    tif->tif_postencode = LERCPostEncode;
    tif->tif_postencode_signature = tif_postencode_LERCPostEncode;
    tif->tif_encoderow = LERCEncode;
    tif->tif_encoderow_signature = tif_encoderow_LERCEncode;
    tif->tif_encodestrip = LERCEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_LERCEncode;
    tif->tif_encodetile = LERCEncode;
    tif->tif_encodetile_signature = tif_encodetile_LERCEncode;
#endif
    tif->tif_cleanup = LERCCleanup;
    tif->tif_cleanup_signature = tif_cleanup_LERCCleanup;
