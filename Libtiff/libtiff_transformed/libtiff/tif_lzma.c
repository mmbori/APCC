...
int TIFFInitLZMA(TIFF *tif, int scheme)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_LZMAVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = LZMAVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_LZMAVSetField; /* hook for codec tags */
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_LZMAFixupTags;
    tif->tif_setupdecode = LZMASetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_LZMASetupDecode;
    tif->tif_predecode = LZMAPreDecode;
    tif->tif_predecode_signature = tif_predecode_LZMAPreDecode;
    tif->tif_decoderow = LZMADecode;
    tif->tif_decoderow_signature = tif_decoderow_LZMADecode;
    tif->tif_decodestrip = LZMADecode;
    tif->tif_decodestrip_signature = tif_decodestrip_LZMADecode;
    tif->tif_decodetile = LZMADecode;
    tif->tif_decodetile_signature = tif_decodetile_LZMADecode;
    tif->tif_setupencode = LZMASetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_LZMASetupEncode;
    tif->tif_preencode = LZMAPreEncode;
    tif->tif_preencode_signature = tif_preencode_LZMAPreEncode;
    tif->tif_postencode = LZMAPostEncode;
    tif->tif_postencode_signature = tif_postencode_LZMAPostEncode;
    tif->tif_encoderow = LZMAEncode;
    tif->tif_encoderow_signature = tif_encoderow_LZMAEncode;
    tif->tif_encodestrip = LZMAEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_LZMAEncode;
    tif->tif_encodetile = LZMAEncode;
    tif->tif_encodetile_signature = tif_encodetile_LZMAEncode;
    tif->tif_cleanup = LZMACleanup;
    tif->tif_cleanup_signature = tif_cleanup_LZMACleanup;
    /*
