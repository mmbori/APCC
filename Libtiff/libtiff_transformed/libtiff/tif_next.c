...
int TIFFInitNeXT(TIFF *tif, int scheme)
{
    ...
    tif->tif_predecode_signature = tif_predecode_NeXTPreDecode;
    tif->tif_decoderow = NeXTDecode;
    tif->tif_decoderow_signature = tif_decoderow_NeXTDecode;
    tif->tif_decodestrip = NeXTDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_NeXTDecode;
    tif->tif_decodetile = NeXTDecode;
    tif->tif_decodetile_signature = tif_decodetile_NeXTDecode;
    return (1);
}
#endif /* NEXT_SUPPORT */
