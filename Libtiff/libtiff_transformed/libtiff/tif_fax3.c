...
typedef struct
{
    ...
    void (*fill)(unsigned char *, uint32_t *, uint32_t *,
                                uint32_t);        /* fill routine */
...
int Fax3SetupState(TIFF *tif)
{
    ...
    */
    ...
    { /* NB: default is 1D routine */
        ...
        tif->tif_decoderow_signature = tif_decoderow_Fax3Decode2D;
        tif->tif_decodestrip = Fax3Decode2D;
        tif->tif_decodestrip_signature = tif_decodestrip_Fax3Decode2D;
        tif->tif_decodetile = Fax3Decode2D;
        tif->tif_decodetile_signature = tif_decodetile_Fax3Decode2D;
    }
...
void Fax3Close(TIFF *tif) { _Fax3Close(tif); }
...
void Fax3Cleanup(TIFF *tif)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = sp->b.vgetparent_signature;
    tif->tif_tagmethods.vsetfield = sp->b.vsetparent;
    tif->tif_tagmethods.vsetfield_signature = sp->b.vsetparent_signature;
    tif->tif_tagmethods.printdir = sp->b.printdir;
    tif->tif_tagmethods.printdir_signature = sp->b.printdir_signature;
...
static int InitCCITTFax3(TIFF *tif)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_Fax3VGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = Fax3VSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_Fax3VSetField; /* hook for codec tags */
    sp->printdir = tif->tif_tagmethods.printdir;
    tif->tif_tagmethods.printdir = Fax3PrintDir;
    tif->tif_tagmethods.printdir_signature = printdir_Fax3PrintDir; /* hook for codec tags */
    sp->groupoptions = 0;
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_Fax3FixupTags;
    tif->tif_setupdecode = Fax3SetupState;
    tif->tif_setupdecode_signature = tif_setupdecode_Fax3SetupState;
    tif->tif_predecode = Fax3PreDecode;
    tif->tif_predecode_signature = tif_predecode_Fax3PreDecode;
    tif->tif_decoderow = Fax3Decode1D;
    tif->tif_decoderow_signature = tif_decoderow_Fax3Decode1D;
    tif->tif_decodestrip = Fax3Decode1D;
    tif->tif_decodestrip_signature = tif_decodestrip_Fax3Decode1D;
    tif->tif_decodetile = Fax3Decode1D;
    tif->tif_decodetile_signature = tif_decodetile_Fax3Decode1D;
    tif->tif_setupencode = Fax3SetupState;
    tif->tif_setupencode_signature = tif_setupencode_Fax3SetupState;
    tif->tif_preencode = Fax3PreEncode;
    tif->tif_preencode_signature = tif_preencode_Fax3PreEncode;
    tif->tif_postencode = Fax3PostEncode;
    tif->tif_postencode_signature = tif_postencode_Fax3PostEncode;
    tif->tif_encoderow = Fax3Encode;
    tif->tif_encoderow_signature = tif_encoderow_Fax3Encode;
    tif->tif_encodestrip = Fax3Encode;
    tif->tif_encodestrip_signature = tif_encodestrip_Fax3Encode;
    tif->tif_encodetile = Fax3Encode;
    tif->tif_encodetile_signature = tif_encodetile_Fax3Encode;
    tif->tif_close = Fax3Close;
    tif->tif_close_signature = tif_close_Fax3Close;
    tif->tif_cleanup = Fax3Cleanup;
    tif->tif_cleanup_signature = tif_cleanup_Fax3Cleanup;
...
int TIFFInitCCITTFax4(TIFF *tif, int scheme)
{
    ...
    { /* reuse G3 support */
        ...
        tif->tif_decoderow_signature = tif_decoderow_Fax4Decode;
        tif->tif_decodestrip = Fax4Decode;
        tif->tif_decodestrip_signature = tif_decodestrip_Fax4Decode;
        tif->tif_decodetile = Fax4Decode;
        tif->tif_decodetile_signature = tif_decodetile_Fax4Decode;
        tif->tif_encoderow = Fax4Encode;
        tif->tif_encoderow_signature = tif_encoderow_Fax4Encode;
        tif->tif_encodestrip = Fax4Encode;
        tif->tif_encodestrip_signature = tif_encodestrip_Fax4Encode;
        tif->tif_encodetile = Fax4Encode;
        tif->tif_encodetile_signature = tif_encodetile_Fax4Encode;
        tif->tif_postencode = Fax4PostEncode;
        tif->tif_postencode_signature = tif_postencode_Fax4PostEncode;
        /*
...
int TIFFInitCCITTRLE(TIFF *tif, int scheme)
{
    ...
    { /* reuse G3 support */
        ...
        tif->tif_decoderow_signature = tif_decoderow_Fax3DecodeRLE;
        tif->tif_decodestrip = Fax3DecodeRLE;
        tif->tif_decodestrip_signature = tif_decodestrip_Fax3DecodeRLE;
        tif->tif_decodetile = Fax3DecodeRLE;
        tif->tif_decodetile_signature = tif_decodetile_Fax3DecodeRLE;
        /*
