...
int TIFFInitPackBits(TIFF *tif, int scheme)
{
    ...
    tif->tif_decoderow_signature = tif_decoderow_PackBitsDecode;
    tif->tif_decodestrip = PackBitsDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_PackBitsDecode;
    tif->tif_decodetile = PackBitsDecode;
    tif->tif_decodetile_signature = tif_decodetile_PackBitsDecode;
#ifndef PACKBITS_READ_ONLY
    tif->tif_preencode = PackBitsPreEncode;
    tif->tif_preencode_signature = tif_preencode_PackBitsPreEncode;
    tif->tif_postencode = PackBitsPostEncode;
    tif->tif_postencode_signature = tif_postencode_PackBitsPostEncode;
    tif->tif_encoderow = PackBitsEncode;
    tif->tif_encoderow_signature = tif_encoderow_PackBitsEncode;
    tif->tif_encodestrip = PackBitsEncodeChunk;
    tif->tif_encodestrip_signature = tif_encodestrip_PackBitsEncodeChunk;
    tif->tif_encodetile = PackBitsEncodeChunk;
    tif->tif_encodetile_signature = tif_encodetile_PackBitsEncodeChunk;
#endif
    return (1);
}
