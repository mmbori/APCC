...
typedef enum {
    fin_readSeparateTilesIntoBuffer = 4395884,
    fin_readContigTilesIntoBuffer = 4395885,
    fin_readContigStripsIntoBuffer = 4395886,
    fin_readSeparateStripsIntoBuffer = 439590
} fin_enum_t;

/* =============== fout (3 functions) =============== */

typedef enum {
    fout_writeBufferToContigTiles = 4395887,
    fout_writeBufferToSeparateTiles = 4395888,
    fout_writeBufferToContigStrips = 4395889,
    fout_writeBufferToSeparateStrips = 439591
} fout_enum_t;

typedef enum {
    fnHashFunc_TIFFHashSetHashPointer = 439592,
    fnHashFunc_hashFuncOffsetToNumber = 439593,
    fnHashFunc_hashFuncNumberToOffset = 439594
} fnHashFunc_enum_t;

typedef enum {
    fnEqualFunc_TIFFHashSetEqualPointer = 439595,
    fnEqualFunc_equalFuncOffsetToNumber = 439596,
    fnEqualFunc_equalFuncNumberToOffset = 439597
} fnEqualFunc_enum_t;
