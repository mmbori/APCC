...
int TIFFInitZIP(TIFF *tif, int scheme)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_ZIPVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = ZIPVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_ZIPVSetField; /* hook for codec tags */
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_ZIPFixupTags;
    tif->tif_setupdecode = ZIPSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_ZIPSetupDecode;
    tif->tif_predecode = ZIPPreDecode;
    tif->tif_predecode_signature = tif_predecode_ZIPPreDecode;
    tif->tif_decoderow = ZIPDecode;
    tif->tif_decoderow_signature = tif_decoderow_ZIPDecode;
    tif->tif_decodestrip = ZIPDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_ZIPDecode;
    tif->tif_decodetile = ZIPDecode;
    tif->tif_decodetile_signature = tif_decodetile_ZIPDecode;
    tif->tif_setupencode = ZIPSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_ZIPSetupEncode;
    tif->tif_preencode = ZIPPreEncode;
    tif->tif_preencode_signature = tif_preencode_ZIPPreEncode;
    tif->tif_postencode = ZIPPostEncode;
    tif->tif_postencode_signature = tif_postencode_ZIPPostEncode;
    tif->tif_encoderow = ZIPEncode;
    tif->tif_encoderow_signature = tif_encoderow_ZIPEncode;
    tif->tif_encodestrip = ZIPEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_ZIPEncode;
    tif->tif_encodetile = ZIPEncode;
    tif->tif_encodetile_signature = tif_encodetile_ZIPEncode;
    tif->tif_cleanup = ZIPCleanup;
    tif->tif_cleanup_signature = tif_cleanup_ZIPCleanup;
    /*
