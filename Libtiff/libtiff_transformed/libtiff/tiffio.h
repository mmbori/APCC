...
struct _TIFFRGBAImage
{
    ...
    union
    {
        ...
        void (*contig)(TIFFRGBAImage *, uint32_t *, uint32_t,
                                  uint32_t, uint32_t, uint32_t, int32_t,
                                  int32_t, unsigned char *);
        void (*separate)(TIFFRGBAImage *, uint32_t *, uint32_t,
                                    uint32_t, uint32_t, uint32_t, int32_t,
                                    int32_t, unsigned char *, unsigned char *,
                                    unsigned char *, unsigned char *);
        
        int any_signature;
        int contig_signature;
        int separate_signature;
    } put;
...
#define FIELD_CUSTOM 65
    ...
    typedef struct
    {
        int (*vsetfield)(TIFF *, uint32_t, va_list); /* tag set routine */
        int (*vgetfield)(TIFF *, uint32_t, va_list); /* tag get routine */
        void (*printdir)(TIFF *, FILE *, long); /* directory print routine */
    
        int vsetfield_signature;
        int vgetfield_signature;
