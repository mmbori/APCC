...
typedef struct
{
    ...
    JMP_BUF exit_jmpbuf;
#endif
    int (*vgetparent)(TIFF *, uint32_t, va_list);
    int (*vsetparent)(TIFF *, uint32_t, va_list);
...
int TIFFInitOJPEG(TIFF *tif, int scheme)
{
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_OJPEGFixupTags;
    tif->tif_setupdecode = OJPEGSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_OJPEGSetupDecode;
    tif->tif_predecode = OJPEGPreDecode;
    tif->tif_predecode_signature = tif_predecode_OJPEGPreDecode;
    tif->tif_postdecode = OJPEGPostDecode;
    tif->tif_postdecode_signature = tif_postdecode_OJPEGPostDecode;
    tif->tif_decoderow = OJPEGDecode;
    tif->tif_decoderow_signature = tif_decoderow_OJPEGDecode;
    tif->tif_decodestrip = OJPEGDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_OJPEGDecode;
    tif->tif_decodetile = OJPEGDecode;
    tif->tif_decodetile_signature = tif_decodetile_OJPEGDecode;
    tif->tif_setupencode = OJPEGSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_OJPEGSetupEncode;
    tif->tif_preencode = OJPEGPreEncode;
    tif->tif_preencode_signature = tif_preencode_OJPEGPreEncode;
    tif->tif_postencode = OJPEGPostEncode;
    tif->tif_postencode_signature = tif_postencode_OJPEGPostEncode;
    tif->tif_encoderow = OJPEGEncode;
    tif->tif_encoderow_signature = tif_encoderow_OJPEGEncode;
    tif->tif_encodestrip = OJPEGEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_OJPEGEncode;
    tif->tif_encodetile = OJPEGEncode;
    tif->tif_encodetile_signature = tif_encodetile_OJPEGEncode;
    tif->tif_cleanup = OJPEGCleanup;
    tif->tif_cleanup_signature = tif_cleanup_OJPEGCleanup;
    tif->tif_data = (uint8_t *)sp;
    /* tif tag methods */
    sp->vgetparent = tif->tif_tagmethods.vgetfield;
    tif->tif_tagmethods.vgetfield = OJPEGVGetField;
    tif->tif_tagmethods.vgetfield_signature = vgetfield_OJPEGVGetField;
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = OJPEGVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_OJPEGVSetField;
    sp->printdir = tif->tif_tagmethods.printdir;
    tif->tif_tagmethods.printdir = OJPEGPrintDir;
    tif->tif_tagmethods.printdir_signature = printdir_OJPEGPrintDir;
