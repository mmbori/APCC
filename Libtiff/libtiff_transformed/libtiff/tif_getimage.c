            ...
            switch (img->bitspersample)
            {
                case 8:
                    if (img->alpha == EXTRASAMPLE_ASSOCALPHA &&
                        ...
                        img->put.contig_signature = contig_putRGBAAcontig8bittile;
                        }
                             ...
                             img->samplesperpixel >= 4) 
                    {
                        if (BuildMapUaToAa(img)) {
                            ...
                            img->put.contig_signature = contig_putRGBUAcontig8bittile;
                        }
                    }
                    else if (img->samplesperpixel >= 3) {
                        img->put.contig = putRGBcontig8bittile;
                        img->put.contig_signature = contig_putRGBcontig8bittile;
                    }
                    break;
                case 16:
                    if (img->alpha == EXTRASAMPLE_ASSOCALPHA &&
                        img->samplesperpixel >= 4)
                    {
                        if (BuildMapBitdepth16To8(img)) {
                            ...
                            img->put.contig_signature = contig_putRGBAAcontig16bittile;
                        }
                    }
                    else if (img->alpha == EXTRASAMPLE_UNASSALPHA &&
                             img->samplesperpixel >= 4)
                    {
                        if (BuildMapBitdepth16To8(img) && BuildMapUaToAa(img)) {
                            ...
                            img->put.contig_signature = contig_putRGBUAcontig16bittile;
                        }
                    }
                    else if (img->samplesperpixel >= 3)
                    {
                        if (BuildMapBitdepth16To8(img)) {
                            ...
                            img->put.contig_signature = contig_putRGBcontig16bittile;
                        }
                    }
                    break;
            }
            ...
            if (img->samplesperpixel >= 4 && buildMap(img))
            {
                if (img->bitspersample == 8)
                {
                    if (!img->Map) {
                        ...
                        img->put.contig_signature = contig_putRGBcontig8bitCMYKtile;
                    }
                    else {
                        img->put.contig = putRGBcontig8bitCMYKMaptile;
                        img->put.contig_signature = contig_putRGBcontig8bitCMYKMaptile;
                    }
                }
            }
            break;
            ...
            if (buildMap(img))
            {
                switch (img->bitspersample)
                {
                    case 8:
                        ...
                        img->put.contig_signature = contig_put8bitcmaptile;
                        break;
                    case 4:
                        img->put.contig = put4bitcmaptile;
                        img->put.contig_signature = contig_put4bitcmaptile;
                        break;
                    case 2:
                        img->put.contig = put2bitcmaptile;
                        img->put.contig_signature = contig_put2bitcmaptile;
                        break;
                    case 1:
                        img->put.contig = put1bitcmaptile;
                        img->put.contig_signature = contig_put1bitcmaptile;
                        break;
                }
            }
            break;
            ...
            if (buildMap(img))
            {
                switch (img->bitspersample)
                {
                    case 16:
                        ...
                        img->put.contig_signature = contig_put16bitbwtile;
                        break;
                    case 8:
                        if (img->alpha && img->samplesperpixel == 2) {
                            img->put.contig = putagreytile;
                            img->put.contig_signature = contig_putagreytile;
                        }
                        else {
                            img->put.contig = putgreytile;
                            img->put.contig_signature = contig_putgreytile;
                        }
                        break;
                    case 4:
                        img->put.contig = put4bitbwtile;
                        img->put.contig_signature = contig_put4bitbwtile;
                        break;
                    case 2:
                        img->put.contig = put2bitbwtile;
                        img->put.contig_signature = contig_put2bitbwtile;
                        break;
                    case 1:
                        img->put.contig = put1bitbwtile;
                        img->put.contig_signature = contig_put1bitbwtile;
                        break;
                }
            }
            break;
                ...
                if (initYCbCrConversion(img) != 0)
                {
                    ...
                    switch ((SubsamplingHor << 4) | SubsamplingVer)
                    {
                        case 0x44:
                            ...
                            img->put.contig_signature = contig_putcontig8bitYCbCr44tile;
                            break;
                        case 0x42:
                            img->put.contig = putcontig8bitYCbCr42tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr42tile;
                            break;
                        case 0x41:
                            img->put.contig = putcontig8bitYCbCr41tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr41tile;
                            break;
                        case 0x22:
                            img->put.contig = putcontig8bitYCbCr22tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr22tile;
                            break;
                        case 0x21:
                            img->put.contig = putcontig8bitYCbCr21tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr21tile;
                            break;
                        case 0x12:
                            img->put.contig = putcontig8bitYCbCr12tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr12tile;
                            break;
                        case 0x11:
                            img->put.contig = putcontig8bitYCbCr11tile;
                            img->put.contig_signature = contig_putcontig8bitYCbCr11tile;
                            break;
                    }
                }
            }
    ...
    switch (img->photometric)
    {
            ...
            switch (img->bitspersample)
            {
                case 8:
                    if (img->alpha == EXTRASAMPLE_ASSOCALPHA) {
                        ...
                        img->put.separate_signature = separate_putRGBAAseparate8bittile;
                    }
                    else if (img->alpha == EXTRASAMPLE_UNASSALPHA)
                    {
                        if (BuildMapUaToAa(img)) {
                            img->put.separate = putRGBUAseparate8bittile;
                            img->put.separate_signature = separate_putRGBUAseparate8bittile;
                        }
                    }
                    else {
                        img->put.separate = putRGBseparate8bittile;
                        img->put.separate_signature = separate_putRGBseparate8bittile;
                    }
                    break;
                case 16:
                    if (img->alpha == EXTRASAMPLE_ASSOCALPHA)
                    {
                        if (BuildMapBitdepth16To8(img)) {
                            ...
                            img->put.separate_signature = separate_putRGBAAseparate16bittile;
                        }
                    }
                    else if (img->alpha == EXTRASAMPLE_UNASSALPHA)
                    {
                        if (BuildMapBitdepth16To8(img) && BuildMapUaToAa(img)) {
                            ...
                            img->put.separate_signature = separate_putRGBUAseparate16bittile;
                        }
                    }
                    else
                    {
                        if (BuildMapBitdepth16To8(img)) {
                            ...
                            img->put.separate_signature = separate_putRGBseparate16bittile;
                        }
                    }
                    break;
            }
        ...
        case PHOTOMETRIC_SEPARATED:
            if (img->bitspersample == 8 && img->samplesperpixel == 4)
            {
                ...
                img->put.separate_signature = separate_putCMYKseparate8bittile;
            }
            break;
        case PHOTOMETRIC_YCBCR:
            if ((img->bitspersample == 8) && (img->samplesperpixel == 3))
                ...
                if (initYCbCrConversion(img) != 0)
                {
                    ...
                    switch ((hs << 4) | vs)
                    {
                        case 0x11:
                            ...
                            img->put.separate_signature = separate_putseparate8bitYCbCr11tile;
                            break;
