...
int TIFFInitThunderScan(TIFF *tif, int scheme)
{
    ...
    tif->tif_setupdecode_signature = tif_setupdecode_ThunderSetupDecode;
    tif->tif_decoderow = ThunderDecodeRow;
    tif->tif_decoderow_signature = tif_decoderow_ThunderDecodeRow;
    tif->tif_decodestrip = ThunderDecodeRow;
    tif->tif_decodestrip_signature = tif_decodestrip_ThunderDecodeRow;
    return (1);
}
