...
int TIFFInitWebP(TIFF *tif, int scheme)
{
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_TWebPVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = TWebPVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_TWebPVSetField; /* hook for codec tags */
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_TWebPFixupTags;
    tif->tif_setupdecode = TWebPSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_TWebPSetupDecode;
    tif->tif_predecode = TWebPPreDecode;
    tif->tif_predecode_signature = tif_predecode_TWebPPreDecode;
    tif->tif_decoderow = TWebPDecode;
    tif->tif_decoderow_signature = tif_decoderow_TWebPDecode;
    tif->tif_decodestrip = TWebPDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_TWebPDecode;
    tif->tif_decodetile = TWebPDecode;
    tif->tif_decodetile_signature = tif_decodetile_TWebPDecode;
    tif->tif_setupencode = TWebPSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_TWebPSetupEncode;
    tif->tif_preencode = TWebPPreEncode;
    tif->tif_preencode_signature = tif_preencode_TWebPPreEncode;
    tif->tif_postencode = TWebPPostEncode;
    tif->tif_postencode_signature = tif_postencode_TWebPPostEncode;
    tif->tif_encoderow = TWebPEncode;
    tif->tif_encoderow_signature = tif_encoderow_TWebPEncode;
    tif->tif_encodestrip = TWebPEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_TWebPEncode;
    tif->tif_encodetile = TWebPEncode;
    tif->tif_encodetile_signature = tif_encodetile_TWebPEncode;
    tif->tif_cleanup = TWebPCleanup;
    tif->tif_cleanup_signature = tif_cleanup_TWebPCleanup;
