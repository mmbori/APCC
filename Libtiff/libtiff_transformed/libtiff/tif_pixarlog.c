...
int TIFFInitPixarLog(TIFF *tif, int scheme)
{
    ...
    tif->tif_fixuptags_signature = tif_fixuptags_PixarLogFixupTags;
    tif->tif_setupdecode = PixarLogSetupDecode;
    tif->tif_setupdecode_signature = tif_setupdecode_PixarLogSetupDecode;
    tif->tif_predecode = PixarLogPreDecode;
    tif->tif_predecode_signature = tif_predecode_PixarLogPreDecode;
    tif->tif_decoderow = PixarLogDecode;
    tif->tif_decoderow_signature = tif_decoderow_PixarLogDecode;
    tif->tif_decodestrip = PixarLogDecode;
    tif->tif_decodestrip_signature = tif_decodestrip_PixarLogDecode;
    tif->tif_decodetile = PixarLogDecode;
    tif->tif_decodetile_signature = tif_decodetile_PixarLogDecode;
    tif->tif_setupencode = PixarLogSetupEncode;
    tif->tif_setupencode_signature = tif_setupencode_PixarLogSetupEncode;
    tif->tif_preencode = PixarLogPreEncode;
    tif->tif_preencode_signature = tif_preencode_PixarLogPreEncode;
    tif->tif_postencode = PixarLogPostEncode;
    tif->tif_postencode_signature = tif_postencode_PixarLogPostEncode;
    tif->tif_encoderow = PixarLogEncode;
    tif->tif_encoderow_signature = tif_encoderow_PixarLogEncode;
    tif->tif_encodestrip = PixarLogEncode;
    tif->tif_encodestrip_signature = tif_encodestrip_PixarLogEncode;
    tif->tif_encodetile = PixarLogEncode;
    tif->tif_encodetile_signature = tif_encodetile_PixarLogEncode;
    tif->tif_close = PixarLogClose;
    tif->tif_close_signature = tif_close_PixarLogClose;
    tif->tif_cleanup = PixarLogCleanup;
    tif->tif_cleanup_signature = tif_cleanup_PixarLogCleanup;
    ...
    tif->tif_tagmethods.vgetfield_signature = vgetfield_PixarLogVGetField; /* hook for codec tags */
    sp->vsetparent = tif->tif_tagmethods.vsetfield;
    tif->tif_tagmethods.vsetfield = PixarLogVSetField;
    tif->tif_tagmethods.vsetfield_signature = vsetfield_PixarLogVSetField; /* hook for codec tags */
