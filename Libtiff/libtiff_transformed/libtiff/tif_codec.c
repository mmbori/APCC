...
static int NotConfigured(TIFF *tif, int scheme)
{
    ...
    tif->tif_fixuptags_signature = tif_fixuptags__notConfigured;
    tif->tif_decodestatus = FALSE;
    tif->tif_setupdecode = _notConfigured;
    tif->tif_setupdecode_signature = tif_setupdecode__notConfigured;
    tif->tif_encodestatus = FALSE;
    tif->tif_setupencode = _notConfigured;
    tif->tif_setupencode_signature = tif_setupencode__notConfigured;
    return (1);
}
