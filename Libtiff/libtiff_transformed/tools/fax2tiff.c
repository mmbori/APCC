...
int copyFaxFile(TIFF *tifin, TIFF *tifout)
{
    ...
    switch (tifin->tif_predecode_signature) {
    case tif_predecode_Fax3PreDecode:
        Fax3PreDecode(tifin, (tsample_t)0);
        break;
    case tif_predecode_LZWPreDecode:
        LZWPreDecode(tifin, (tsample_t)0);
        break;
    case tif_predecode_NeXTPreDecode:
        NeXTPreDecode(tifin, (tsample_t)0);
        break;
    case tif_predecode_PixarLogPreDecode:
        PixarLogPreDecode(tifin, (tsample_t)0);
        break;
    case tif_predecode_ZIPPreDecode:
        ZIPPreDecode(tifin, (tsample_t)0);
        break;
    case tif_predecode__TIFFNoPreCode:
        _TIFFNoPreCode(tifin, (tsample_t)0);
        break;
    default:
        invalidFunctionWasCalled();
        break;
    ...
    while (tifin->tif_rawcc > 0)
    {
        ...
        switch (tifin->tif_decoderow_signature) {
    case tif_decoderow_DumpModeDecode:
        ok = DumpModeDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_Fax3Decode1D:
        ok = Fax3Decode1D(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_Fax3Decode2D:
        ok = Fax3Decode2D(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_Fax3DecodeRLE:
        ok = Fax3DecodeRLE(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_Fax4Decode:
        ok = Fax4Decode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_LZWDecode:
        ok = LZWDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_LZWDecodeCompat:
        ok = LZWDecodeCompat(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_LogL16Decode:
        ok = LogL16Decode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_LogLuvDecode24:
        ok = LogLuvDecode24(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_LogLuvDecode32:
        ok = LogLuvDecode32(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_NeXTDecode:
        ok = NeXTDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_PackBitsDecode:
        ok = PackBitsDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_PixarLogDecode:
        ok = PixarLogDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_PredictorDecodeRow:
        ok = PredictorDecodeRow(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_ThunderDecodeRow:
        ok = ThunderDecodeRow(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow_ZIPDecode:
        ok = ZIPDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    case tif_decoderow__TIFFNoRowDecode:
        ok = _TIFFNoRowDecode(tifin, (uint8_t *)rowbuf, linesize, 0);
        break;
    default:
        invalidFunctionWasCalled();
        break;
