...
#define XTIFFP_PRINT 0x00000001
    ...
    int (*xtif_vsetfield)(TIFF *, uint32_t, va_list); /* inherited tag set routine */
    int (*xtif_vgetfield)(TIFF *, uint32_t, va_list); /* inherited tag get routine */
    void (*xtif_printdir)(TIFF *, FILE *, long); /* inherited dir print method */
};
