...
start_pass_lossless(j_compress_ptr cinfo)
{
  ...
  if (cinfo->Al) {
    ...
    losslessc->scaler_scale_signature = scaler_scale_simple_downscale;
  }
  else {
    losslessc->scaler_scale = noscale;
    losslessc->scaler_scale_signature = scaler_scale_noscale;
  }
...
_jinit_lossless_compressor(j_compress_ptr cinfo)
{
  ...
  losslessc->pub.start_pass_signature = start_pass_start_pass_lossless;
}
