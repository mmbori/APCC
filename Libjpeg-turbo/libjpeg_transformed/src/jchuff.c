...
start_pass_huff(j_compress_ptr cinfo, boolean gather_statistics)
{
  ...
  if (gather_statistics) {
    ...
    entropy->pub.encode_mcu_signature = encode_mcu_encode_mcu_gather;
    ...
    entropy->pub.encode_mcu_signature = encode_mcu_encode_mcu_huff;
...
jinit_huff_encoder(j_compress_ptr cinfo)
{
  ...
  entropy->pub.start_pass_signature = start_pass_start_pass_huff;
