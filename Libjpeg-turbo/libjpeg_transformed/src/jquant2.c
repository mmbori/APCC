...
start_pass_2_quant(j_decompress_ptr cinfo, boolean is_pre_scan)
{
  ...
  if (is_pre_scan) {
    ...
    cquantize->pub.finish_pass_signature = finish_pass_finish_pass1;
    ...
    cquantize->pub.finish_pass_signature = finish_pass_finish_pass2;
...
_jinit_2pass_quantizer(j_decompress_ptr cinfo)
{
  ...
  cquantize->pub.start_pass_signature = start_pass_start_pass_2_quant;
  cquantize->pub.new_color_map = new_color_map_2_quant;
  cquantize->pub.new_color_map_signature = new_color_map_new_color_map_2_quant;
