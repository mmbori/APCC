                            ...
                            jvirt_barray_ptr *coef_arrays)
{
  ...
  coef->pub.start_pass_signature = start_pass_start_pass_coef;
  coef->pub.compress_data = compress_output;
  coef->pub.compress_data_signature = compress_data_compress_output;
  coef->pub.compress_data_12 = compress_output_12;
  coef->pub.compress_data_12_signature = compress_data_12_compress_output_12;
