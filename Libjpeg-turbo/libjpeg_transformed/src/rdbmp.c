...
preload_image(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  case 8:
    ...
    source->pub.get_pixel_rows_signature = get_pixel_rows_get_8bit_row;
    break;
  case 24:
    source->pub.get_pixel_rows = get_24bit_row;
    source->pub.get_pixel_rows_signature = get_pixel_rows_get_24bit_row;
    break;
  case 32:
    source->pub.get_pixel_rows = get_32bit_row;
    source->pub.get_pixel_rows_signature = get_pixel_rows_get_32bit_row;
    break;
  default:
...
jinit_read_bmp(j_compress_ptr cinfo, boolean use_inversion_array)
{
  ...
  source->pub.start_input_signature = start_input_start_input_bmp;
  source->pub.finish_input = finish_input_bmp;
  source->pub.finish_input_signature = finish_input_finish_input_bmp;
