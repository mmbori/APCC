...
_jinit_write_ppm(j_decompress_ptr cinfo)
{
  ...
  dest->pub.start_output_signature = start_output_start_output_ppm;
  dest->pub.finish_output = finish_output_ppm;
  dest->pub.finish_output_signature = finish_output_finish_output_ppm;
  dest->pub.calc_buffer_dimensions = calc_buffer_dimensions_ppm;
  dest->pub.calc_buffer_dimensions_signature = calc_buffer_dimensions_calc_buffer_dimensions_ppm;

  /* Calculate output image dimensions so we can allocate space */
  jpeg_calc_output_dimensions(cinfo);

  /* Create physical I/O buffer */
  // switch (dest->pub.calc_buffer_dimensions_signature) {
  // case calc_buffer_dimensions_calc_buffer_dimensions_gif:
  //     calc_buffer_dimensions_gif(cinfo, (djpeg_dest_ptr)dest);
  //     break;
  // case calc_buffer_dimensions_calc_buffer_dimensions_ppm:
  //     calc_buffer_dimensions_ppm(cinfo, (djpeg_dest_ptr)dest);
  //     break;
  // case calc_buffer_dimensions_calc_buffer_dimensions_tga:
  //     calc_buffer_dimensions_tga(cinfo, (djpeg_dest_ptr)dest);
  //     break;
  // default:
  ...
  if (cinfo->quantize_colors || BITS_IN_JSAMPLE != 8 ||
    ...
    if (!cinfo->quantize_colors) {
      if (IsExtRGB(cinfo->out_color_space)) {
        ...
        dest->pub.put_pixel_rows_signature = put_pixel_rows_put_rgb;
      }
      else if (cinfo->out_color_space == JCS_CMYK) {
        dest->pub.put_pixel_rows = put_cmyk;
        dest->pub.put_pixel_rows_signature = put_pixel_rows_put_cmyk;
      }
      else {
        dest->pub.put_pixel_rows = copy_pixel_rows;
        dest->pub.put_pixel_rows_signature = put_pixel_rows_copy_pixel_rows;
      }
    } else if (cinfo->out_color_space == JCS_GRAYSCALE) {
      dest->pub.put_pixel_rows = put_demapped_gray;
      dest->pub.put_pixel_rows_signature = put_pixel_rows_put_demapped_gray;
    }
    else {
      dest->pub.put_pixel_rows = put_demapped_rgb;
      dest->pub.put_pixel_rows_signature = put_pixel_rows_put_demapped_rgb;
    }
  } else {
