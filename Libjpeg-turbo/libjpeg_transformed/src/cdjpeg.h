...
struct cjpeg_source_struct {
  ...
  int start_input_signature;
  int get_pixel_rows_signature;
  int finish_input_signature;
};
...
struct djpeg_dest_struct {
  ...
  int start_output_signature;
  int put_pixel_rows_signature;
  int finish_output_signature;
  int calc_buffer_dimensions_signature;
};
