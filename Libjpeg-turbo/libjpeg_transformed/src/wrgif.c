...
_jinit_write_gif(j_decompress_ptr cinfo, boolean is_lzw)
{
  ...
  dest->pub.start_output_signature = start_output_start_output_gif;
  dest->pub.finish_output = finish_output_gif;
  dest->pub.finish_output_signature = finish_output_finish_output_gif;
  dest->pub.calc_buffer_dimensions = calc_buffer_dimensions_gif;
  dest->pub.calc_buffer_dimensions_signature = calc_buffer_dimensions_calc_buffer_dimensions_gif;
  ...
  if (is_lzw) {
    ...
    dest->pub.put_pixel_rows_signature = put_pixel_rows_put_LZW_pixel_rows;
    ...
    dest->pub.put_pixel_rows_signature = put_pixel_rows_put_raw_pixel_rows;
    /* Mark tables unused */
    dest->hash_code = NULL;
