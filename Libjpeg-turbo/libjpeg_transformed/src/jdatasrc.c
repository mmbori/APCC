...
jpeg_stdio_src(j_decompress_ptr cinfo, FILE *infile)
{
  ...
  src->pub.resync_to_restart_signature = resync_to_restart_jpeg_resync_to_restart; /* use default method */
             ...
             unsigned long insize)
{
  ...
  src->init_source_signature = init_source_init_mem_source;
  src->fill_input_buffer = fill_mem_input_buffer;
  src->fill_input_buffer_signature = fill_input_buffer_fill_mem_input_buffer;
  src->skip_input_data = skip_input_data;
  src->resync_to_restart = jpeg_resync_to_restart;
  src->resync_to_restart_signature = resync_to_restart_jpeg_resync_to_restart; /* use default method */
