              ...
              unsigned long *outsize)
{
  ...
  dest->pub.init_destination_signature = init_destination_init_mem_destination;
  dest->pub.empty_output_buffer = empty_mem_output_buffer;
  dest->pub.empty_output_buffer_signature = empty_output_buffer_empty_mem_output_buffer;
  dest->pub.term_destination = term_mem_destination;
  dest->pub.term_destination_signature = term_destination_term_mem_destination;
