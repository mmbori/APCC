...
#define JMSG_STR_PARM_MAX  80
  ...
  int error_exit_signature;
  int emit_message_signature;
  int output_message_signature;
  int format_message_signature;
};
...
struct jpeg_progress_mgr {
  ...
  int progress_monitor_signature;
};
...
struct jpeg_destination_mgr {
  ...
  int init_destination_signature;
  int empty_output_buffer_signature;
  int term_destination_signature;
};
...
struct jpeg_source_mgr {
  ...
  int init_source_signature;
  int fill_input_buffer_signature;
  int skip_input_data_signature;
  int resync_to_restart_signature;
  int term_source_signature;
};
...
struct jpeg_memory_mgr {
  ...
  int alloc_small_signature;
  int alloc_large_signature;
  int alloc_sarray_signature;
  int alloc_barray_signature;
  int request_virt_sarray_signature;
  int request_virt_barray_signature;
  int realize_virt_arrays_signature;
  int access_virt_sarray_signature;
  int access_virt_barray_signature;
  int free_pool_signature;
  int self_destruct_signature;
};
