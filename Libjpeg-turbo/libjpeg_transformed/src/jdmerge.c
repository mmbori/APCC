...
_jinit_merged_upsampler(j_decompress_ptr cinfo)
{
  ...
  upsample->pub.start_pass_signature = start_pass_start_pass_merged_upsample;
  ...
  if (cinfo->max_v_samp_factor == 2) {
    ...
    if (jsimd_can_h2v2_merged_upsample())
      ...
      upsample->upmethod_signature = upmethod_jsimd_h2v2_merged_upsample;
    else
#endif
      upsample->upmethod = h2v2_merged_upsample;
      upsample->upmethod_signature = upmethod_h2v2_merged_upsample;
    if (cinfo->out_color_space == JCS_RGB565) {
      if (cinfo->dither_mode != JDITHER_NONE) {
        upsample->upmethod = h2v2_merged_upsample_565D;
        upsample->upmethod_signature = upmethod_h2v2_merged_upsample_565D;
      } else {
        upsample->upmethod = h2v2_merged_upsample_565;
        upsample->upmethod_signature = upmethod_h2v2_merged_upsample_565;
      }
    }
    ...
    if (jsimd_can_h2v1_merged_upsample())
      ...
      upsample->upmethod_signature = upmethod_jsimd_h2v1_merged_upsample;
    else
#endif
      upsample->upmethod = h2v1_merged_upsample;
      upsample->upmethod_signature = upmethod_h2v1_merged_upsample;
    if (cinfo->out_color_space == JCS_RGB565) {
      if (cinfo->dither_mode != JDITHER_NONE) {
        upsample->upmethod = h2v1_merged_upsample_565D;
        upsample->upmethod_signature = upmethod_h2v1_merged_upsample_565D;
      } else {
        upsample->upmethod = h2v1_merged_upsample_565;
        upsample->upmethod_signature = upmethod_h2v1_merged_upsample_565;
      }
    }
    /* No spare row needed */
