...
_jinit_1pass_quantizer(j_decompress_ptr cinfo)
{
  ...
  cquantize->pub.start_pass_signature = start_pass_start_pass_1_quant;
  cquantize->pub.finish_pass = finish_pass_1_quant;
  cquantize->pub.finish_pass_signature = finish_pass_finish_pass_1_quant;
  cquantize->pub.new_color_map = new_color_map_1_quant;
  cquantize->pub.new_color_map_signature = new_color_map_new_color_map_1_quant;
