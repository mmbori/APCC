...
start_input_ppm(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  case '2':                     /* it's a text-format PGM file */
    ...
    if (cinfo->in_color_space == JCS_GRAYSCALE) {
      ...
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_text_gray_row;
    }
    else if (IsExtRGB(cinfo->in_color_space)) {
      source->pub.get_pixel_rows = get_text_gray_rgb_row;
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_text_gray_rgb_row;
    }
    else if (cinfo->in_color_space == JCS_CMYK) {
      source->pub.get_pixel_rows = get_text_gray_cmyk_row;
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_text_gray_cmyk_row;
    }
    else
  ...
  case '3':                     /* it's a text-format PPM file */
    ...
    if (IsExtRGB(cinfo->in_color_space)) {
      ...
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_text_rgb_row;
    }
    else if (cinfo->in_color_space == JCS_CMYK) {
      source->pub.get_pixel_rows = get_text_rgb_cmyk_row;
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_text_rgb_cmyk_row;
    }
    else
      ERREXIT(cinfo, JERR_BAD_IN_COLORSPACE);
    need_iobuffer = FALSE;
  ...
  case '5':                     /* it's a raw-format PGM file */
    ...
    if (maxval > 255) {
      if (cinfo->in_color_space == JCS_GRAYSCALE) {
        ...
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_word_gray_row;
      }
      else if (IsExtRGB(cinfo->in_color_space)) {
        source->pub.get_pixel_rows = get_word_gray_rgb_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_word_gray_rgb_row;
      }
      else if (cinfo->in_color_space == JCS_CMYK) {
        source->pub.get_pixel_rows = get_word_gray_cmyk_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_word_gray_cmyk_row;
      }
      else
        ERREXIT(cinfo, JERR_BAD_IN_COLORSPACE);
      ...
      source->pub.get_pixel_rows_signature = get_pixel_rows_get_raw_row;
      use_raw_buffer = TRUE;
      need_rescale = FALSE;
    } else {
      if (cinfo->in_color_space == JCS_GRAYSCALE) {
        source->pub.get_pixel_rows = get_scaled_gray_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_scaled_gray_row;
      }
      else if (IsExtRGB(cinfo->in_color_space)) {
        source->pub.get_pixel_rows = get_gray_rgb_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_gray_rgb_row;
      }
      else if (cinfo->in_color_space == JCS_CMYK) {
        source->pub.get_pixel_rows = get_gray_cmyk_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_gray_cmyk_row;
      }
      else
        ERREXIT(cinfo, JERR_BAD_IN_COLORSPACE);
    }
  ...
  case '6':                     /* it's a raw-format PPM file */
    ...
    if (maxval > 255) {
      if (IsExtRGB(cinfo->in_color_space)) {
        ...
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_word_rgb_row;
      }
      else if (cinfo->in_color_space == JCS_CMYK) {
        source->pub.get_pixel_rows = get_word_rgb_cmyk_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_word_rgb_cmyk_row;
      }
      else
        ERREXIT(cinfo, JERR_BAD_IN_COLORSPACE);
    } else if (maxval <= _MAXJSAMPLE && sizeof(_JSAMPLE) == sizeof(U_CHAR) &&
      ...
      if (IsExtRGB(cinfo->in_color_space)) {
        ...
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_rgb_row;
      }
      else if (cinfo->in_color_space == JCS_CMYK) {
        source->pub.get_pixel_rows = get_rgb_cmyk_row;
        source->pub.get_pixel_rows_signature = get_pixel_rows_get_rgb_cmyk_row;
      }
      else
        ERREXIT(cinfo, JERR_BAD_IN_COLORSPACE);
    }
...
_jinit_read_ppm(j_compress_ptr cinfo)
{
  ...
  source->pub.start_input_signature = start_input_start_input_ppm;
  source->pub.finish_input = finish_input_ppm;
  source->pub.finish_input_signature = finish_input_finish_input_ppm;
