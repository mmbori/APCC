...
jinit_marker_reader(j_decompress_ptr cinfo)
{
  ...
  marker->process_COM_signature = process_COM_skip_variable;
                  ...
                  unsigned int length_limit)
{
  my_marker_ptr marker = (my_marker_ptr)cinfo->marker;
  long maxlength;
  boolean (*processor) (j_decompress_ptr cinfo);
  ...
  if (marker_code == (int)M_COM) {
    ...
    marker->process_COM_signature = process_COM_processor;
