...
start_input_gif(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  if (source->is_interlaced) {
    ...
    source->pub.get_pixel_rows_signature = get_pixel_rows_load_interlaced_image;
  } else {
...
load_interlaced_image(j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  source->pub.get_pixel_rows_signature = get_pixel_rows_get_interlaced_row;
...
jinit_read_gif(j_compress_ptr cinfo)
{
  ...
  source->pub.start_input_signature = start_input_start_input_gif;
  source->pub.finish_input = finish_input_gif;
  source->pub.finish_input_signature = finish_input_finish_input_gif;
