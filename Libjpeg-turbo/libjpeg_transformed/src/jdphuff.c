...
start_pass_phuff_decoder(j_decompress_ptr cinfo)
{
  ...
  if (cinfo->Ah == 0) {
    if (is_DC_band) {
      ...
      entropy->pub.decode_mcu_signature = decode_mcu_decode_mcu_DC_first;
    }
    else {
      entropy->pub.decode_mcu = decode_mcu_AC_first;
      entropy->pub.decode_mcu_signature = decode_mcu_decode_mcu_AC_first;
    }
  } else {
    if (is_DC_band) {
      entropy->pub.decode_mcu = decode_mcu_DC_refine;
      entropy->pub.decode_mcu_signature = decode_mcu_decode_mcu_DC_refine;
    }
    else {
      entropy->pub.decode_mcu = decode_mcu_AC_refine;
      entropy->pub.decode_mcu_signature = decode_mcu_decode_mcu_AC_refine;
    }
  }
...
jinit_phuff_decoder(j_decompress_ptr cinfo)
{
  ...
  entropy->pub.start_pass_signature = start_pass_start_pass_phuff_decoder;
