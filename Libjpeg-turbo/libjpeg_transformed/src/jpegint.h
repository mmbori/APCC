...
struct jpeg_comp_master {
  ...
  int prepare_for_pass_signature;
  int pass_startup_signature;
  int finish_pass_signature;
};
...
struct jpeg_c_main_controller {
  ...
  void (*process_data_16) (j_compress_ptr cinfo, J16SAMPARRAY input_buf,
                           ...
                           int start_pass_signature;
                           int process_data_signature;
                           int process_data_12_signature;
};
...
struct jpeg_c_prep_controller {
  ...
  void (*pre_process_data_16) (j_compress_ptr cinfo, J16SAMPARRAY input_buf,
                               ...
                               int start_pass_signature;
                               int pre_process_data_signature;
                               int pre_process_data_12_signature;
};
...
struct jpeg_c_coef_controller {
  ...
  int start_pass_signature;
  int compress_data_signature;
  int compress_data_12_signature;
};
...
struct jpeg_color_converter {
  ...
  void (*color_convert_16) (j_compress_ptr cinfo, J16SAMPARRAY input_buf,
                            ...
                            int start_pass_signature;
                            int color_convert_signature;
                            int color_convert_12_signature;
};
...
struct jpeg_downsampler {
  ...
  int start_pass_signature;
  int downsample_signature;
  int downsample_12_signature;
};
...
struct jpeg_forward_dct {
  ...
  void (*forward_DCT_12) (j_compress_ptr cinfo, jpeg_component_info *compptr,
                          ...
                          int start_pass_signature;
                          int forward_DCT_signature;
                          int forward_DCT_12_signature;
};
...
struct jpeg_entropy_encoder {
  ...
  int start_pass_signature;
  int encode_mcu_signature;
  int encode_mcus_signature;
  int finish_pass_signature;
};
...
struct jpeg_marker_writer {
  ...
  int write_file_header_signature;
  int write_frame_header_signature;
  int write_scan_header_signature;
  int write_file_trailer_signature;
  int write_tables_only_signature;
  int write_marker_header_signature;
  int write_marker_byte_signature;
};
...
struct jpeg_decomp_master {
  ...
  int prepare_for_output_pass_signature;
  int finish_output_pass_signature;
};
...
struct jpeg_input_controller {
  ...
  int consume_input_signature;
  int reset_input_controller_signature;
  int start_input_pass_signature;
  int finish_input_pass_signature;
};
...
struct jpeg_d_coef_controller {
  ...
  int start_input_pass_signature;
  int consume_data_signature;
  int start_output_pass_signature;
  int decompress_data_signature;
  int decompress_data_12_signature;
};
...
struct jpeg_d_post_controller {
  ...
  void (*post_process_data_16) (j_decompress_ptr cinfo, J16SAMPIMAGE input_buf,
                                ...
                                int start_pass_signature;
                                int post_process_data_signature;
                                int post_process_data_12_signature;
};
...
struct jpeg_marker_reader {
  ...
  int reset_marker_reader_signature;
  int read_markers_signature;
  int read_restart_marker_signature;
};
...
struct jpeg_entropy_decoder {
  ...
  int start_pass_signature;
  int decode_mcu_signature;
  int decode_mcus_signature;
  int process_restart_signature;
};
...
struct jpeg_upsampler {
  ...
  int start_pass_signature;
  int upsample_signature;
  int upsample_12_signature;
};
...
struct jpeg_color_quantizer {
  ...
  int start_pass_signature;
  int color_quantize_signature;
  int color_quantize_12_signature;
  int finish_pass_signature;
  int new_color_map_signature;
};
