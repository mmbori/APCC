...
#define PR_BUILD_OPTS " '--enable-devel' '--enable-static' 'CFLAGS=-g -O0 -fno-omit-frame-pointer' 'LDFLAGS=-static'"
...
#define PR_BUILD_LDFLAGS "-Wl,-L$(top_srcdir)/lib,-L$(top_builddir)/lib -static -rdynamic "

/* Define to be the build LIBS.  */
#define PR_BUILD_LIBS " -lcap  -lpam -lcrypt  "
...
/* #undef PR_USE_OPENSSL_OSSL_PROVIDER_LOAD */

/* Define if OpenSSL SSL num ticket support, if available, should be used.  */
/* #undef PR_USE_OPENSSL_SSL_NUM_TICKETS */
