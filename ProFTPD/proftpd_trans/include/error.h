...
struct err_explain_rec {
  ...
  const char *(*explain_writev)(pool *p, int xerrno, int fd,
    ...
    int explain_accept_signature;
    int explain_bind_signature;
    int explain_chdir_signature;
    int explain_chmod_signature;
    int explain_chown_signature;
    int explain_chroot_signature;
    int explain_close_signature;
    int explain_closedir_signature;
    int explain_connect_signature;
    int explain_fchmod_signature;
    int explain_fchown_signature;
    int explain_fclose_signature;
    int explain_fcntl_signature;
    int explain_fdopen_signature;
    int explain_flock_signature;
    int explain_fopen_signature;
    int explain_fork_signature;
    int explain_fstat_signature;
    int explain_fstatfs_signature;
    int explain_fstatvfs_signature;
    int explain_fsync_signature;
    int explain_ftruncate_signature;
    int explain_futimes_signature;
    int explain_getaddrinfo_signature;
    int explain_gethostbyname_signature;
    int explain_gethostbyname2_signature;
    int explain_gethostname_signature;
    int explain_getnameinfo_signature;
    int explain_getpeername_signature;
    int explain_getrlimit_signature;
    int explain_getsockname_signature;
    int explain_getsockopt_signature;
    int explain_lchown_signature;
    int explain_link_signature;
    int explain_listen_signature;
    int explain_lseek_signature;
    int explain_lstat_signature;
    int explain_mkdir_signature;
    int explain_mkdtemp_signature;
    int explain_mkstemp_signature;
    int explain_open_signature;
    int explain_opendir_signature;
    int explain_read_signature;
    int explain_readdir_signature;
    int explain_readlink_signature;
    int explain_readv_signature;
    int explain_rename_signature;
    int explain_rmdir_signature;
    int explain_setegid_signature;
    int explain_seteuid_signature;
    int explain_setgid_signature;
    int explain_setregid_signature;
    int explain_setresgid_signature;
    int explain_setresuid_signature;
    int explain_setreuid_signature;
    int explain_setrlimit_signature;
    int explain_setsockopt_signature;
    int explain_setuid_signature;
    int explain_socket_signature;
    int explain_stat_signature;
    int explain_statfs_signature;
    int explain_statvfs_signature;
    int explain_symlink_signature;
    int explain_truncate_signature;
    int explain_unlink_signature;
    int explain_utimes_signature;
    int explain_write_signature;
    int explain_writev_signature;
};
