...
static SList *	slist_sort_merge    (SList *left, SList *right,
				     int (*compare)(const SList *item1, const SList *item2, void *userdata), void *userdata);
...
void *
slist_remove (SList **phead, void * (*find)(SList *item, void *userdata), void *matchdata)
{
  SList *stale = 0;
  void *result = 0;
...
void *
slist_find (SList *slist, void * (*find)(SList *item, void *userdata), void *matchdata)
{
  void *result = 0;
...
void *
slist_foreach (SList *slist, void * (*foreach)(SList *item, void *userdata), void *userdata)
{
  void *result = 0;
...
static SList *
slist_sort_merge (SList *left, SList *right, int (*compare)(const SList *item1, const SList *item2, void *userdata),
		  void *userdata)
{
  SList merged, *insert;
...
SList *
slist_sort (SList *slist, int (*compare)(const SList *item1, const SList *item2, void *userdata), void *userdata)
{
  SList *left, *right;
