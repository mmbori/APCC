...
static	int	foreach_dirinpath     (const char *search_path,
				       ...
				       int (*func)(char *filename, void *data1, void *data2),
...
foreach_dirinpath (const char *search_path, const char *base_name,
		   int (*func)(char *filename, void *data1, void *data2), void *data1, void *data2)
{
  int	 result		= 0;
...
typedef struct {
  ...
  int (*iface)(lt_dlhandle handle, const char *id_string);
} lt__interface_id;

lt_dlinterface_id
lt_dlinterface_register (const char *id_string, int (*iface)(lt_dlhandle handle, const char *id_string))
{
