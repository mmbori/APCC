    ...
    for entry in fp_data:
        ...
        if len(processed_funcs) == 1:
            ...
            for func in processed_funcs:
                if first:
                    out.append(f"+     if (E->{fp_name}_signature == {fp_name}_signatures[{fp_name}_{func}]) {{\n")
                    if func == '0':
                        out.append(f"+         return 0;\n")
                    elif func == 'NULL':
                        out.append(f"+         return NULL;\n")
                    ...
                    out.append(f"+     else if (E->{fp_name}_signature == {fp_name}_signatures[{fp_name}_{func}]) {{\n")
                    if func == '0':
                        out.append(f"+         return 0;\n")
                    elif func == 'NULL':
                        out.append(f"+         return NULL;\n")
...
def generate_assignment_arrow_rules(fp_data: List[Dict], removed_functions: Set[str]) -> str:
    ...
    for entry in fp_data:
        ...
        if len(processed_funcs) == 1:
            ...
            for func in processed_funcs:
                if first:
                    out.append(f"+     if (E2->{fp_name}_signature == {fp_name}_signatures[{fp_name}_{func}]) {{\n")
                    if func == '0':
                        out.append(f"+         E1 = 0;\n")
                    elif func == 'NULL':
                        out.append(f"+         E1 = NULL;\n")
                    ...
                    out.append(f"+     else if (E2->{fp_name}_signature == {fp_name}_signatures[{fp_name}_{func}]) {{\n")
                    if func == '0':
                        out.append(f"+         E1 = 0;\n")
                    elif func == 'NULL':
                        out.append(f"+         E1 = NULL;\n")
