...
typedef struct {
    ...
    ngx_chain_t *(*udp_send_chain)(ngx_connection_t *c, ngx_chain_t *in,
    off_t limit);
    ...
    int recv_signature;
    int recv_chain_signature;
    int udp_recv_signature;
    int send_signature;
    int udp_send_signature;
    int udp_send_chain_signature;
    int send_chain_signature;
} ngx_os_io_t;
