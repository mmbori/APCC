...
extern ngx_int_t (*ngx_http_top_header_filter)(ngx_http_request_t *r);
extern ngx_int_t (*ngx_http_top_early_hints_filter)(ngx_http_request_t *r);
extern ngx_int_t (*ngx_http_top_body_filter)
    (ngx_http_request_t *r, ngx_chain_t *chain);
extern ngx_int_t (*ngx_http_top_request_body_filter)
    (ngx_http_request_t *r, ngx_chain_t *chain);
