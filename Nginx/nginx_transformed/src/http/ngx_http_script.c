    ...
    ngx_str_t *value)
{
    ...
    while (*(uintptr_t *) e.ip) {
        ...
        if (lcode == ngx_http_script_copy_len_code) {
            len += ngx_http_script_copy_len_code(&e);
        }
        else if (lcode == ngx_http_script_copy_var_len_code) {
            len += ngx_http_script_copy_var_len_code(&e);
        }
        else if (lcode == ngx_http_script_full_name_len_code) {
            len += ngx_http_script_full_name_len_code(&e);
        }
        // len += lcode(&e);
    }
    ...
    ngx_uint_t last)
{
    ...
    code->code_signature = code_ngx_http_script_copy_len_code;
    code->len = len;
...
ngx_http_script_add_var_code(ngx_http_script_compile_t *sc, ngx_str_t *name)
{
    ...
    code->code_signature = code_ngx_http_script_copy_var_len_code;
...
ngx_http_script_regex_start_code(ngx_http_script_engine_t *e)
{
    ...
    if (code->lengths == NULL) {
        ...
        while (*(uintptr_t *) le.ip) {
            ...
            // len += lcode(&le);
            if (lcode == ngx_http_script_copy_len_code) {
            len += ngx_http_script_copy_len_code(&le);
            }
            else if (lcode == ngx_http_script_copy_var_len_code) {
                len += ngx_http_script_copy_var_len_code(&le);
            }
            else if (lcode == ngx_http_script_full_name_len_code) {
                len += ngx_http_script_full_name_len_code(&le);
            }
        }
...
ngx_http_script_add_capture_code(ngx_http_script_compile_t *sc, ngx_uint_t n)
{
    ...
    code->code_signature = code_ngx_http_script_copy_capture_len_code;
    code->n = 2 * n;
...
ngx_http_script_add_full_name_code(ngx_http_script_compile_t *sc)
{
    ...
    code->code_signature = code_ngx_http_script_full_name_len_code;
