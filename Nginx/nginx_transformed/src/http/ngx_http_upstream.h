...
typedef struct {
    ...
    int init_upstream_signature;
    int init_signature;

    int handler_signature;
    int copy_handler_signature;
...
typedef struct {
    ngx_int_t (*init_upstream)(ngx_conf_t *cf,
    ngx_http_upstream_srv_conf_t *us);
    ngx_int_t (*init)(ngx_http_request_t *r,
    ngx_http_upstream_srv_conf_t *us);
    void                            *data;
...
typedef struct {
    ...
    ngx_uint_t                       offset;
    ngx_int_t (*copy_handler)(ngx_http_request_t *r,
    ngx_table_elt_t *h, ngx_uint_t offset);
    ngx_uint_t                       conf;
...
struct ngx_http_upstream_s {
    ...
    int read_event_handler_signature;
    int write_event_handler_signature;
    int input_filter_init_signature;
    int input_filter_signature;
    int reinit_request_signature;
    int process_header_signature;
    int abort_request_signature;
    int finalize_request_signature;
    int rewrite_redirect_signature;
    int rewrite_cookie_signature;
};
