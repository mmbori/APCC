...
ngx_int_t ngx_http_upstream_init_ip_hash_peer(ngx_http_request_t *r,
    ngx_http_upstream_srv_conf_t *us);
ngx_int_t ngx_http_upstream_get_ip_hash_peer(ngx_peer_connection_t *pc,
    void *data);
...
ngx_http_upstream_get_ip_hash_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    if (iphp->tries > 20 || iphp->rrp.peers->number < 2) {
        ...
        return ngx_http_upstream_get_round_robin_peer(pc, &iphp->rrp);
    }
