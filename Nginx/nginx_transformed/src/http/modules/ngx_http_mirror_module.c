...
char *ngx_http_mirror_merge_loc_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static ngx_http_module_t ngx_http_mirror_module_ctx = {
    ...
    // postconfiguration_ngx_http_mirror_init
    // create_main_conf_NULL,
    // init_main_conf_NULL,
    // create_srv_conf_NULL,
    // merge_srv_conf_NULL,
    // create_loc_conf_ngx_http_mirror_create_loc_conf,
    // merge_loc_conf_ngx_http_mirror_merge_loc_conf
};
...
ngx_http_mirror_handler(ngx_http_request_t *r)
{
    ...
    if (mlcf->request_body) {
        ...
        rc = ngx_http_read_client_request_body(r, ngx_http_mirror_body_handler, post_handler_ngx_http_mirror_body_handler);
