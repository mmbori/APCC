...
char *ngx_http_limit_req_merge_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static ngx_http_module_t  ngx_http_limit_req_module_ctx = {
    ...
    ,
    preconfiguration_ngx_http_limit_req_add_variables,
    postconfiguration_ngx_http_limit_req_init,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_limit_req_create_conf,
    merge_loc_conf_ngx_http_limit_req_merge_conf
};
