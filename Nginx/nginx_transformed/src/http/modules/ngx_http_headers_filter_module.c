...
static ngx_int_t ngx_http_add_multi_header_lines(ngx_http_request_t *r,
    ngx_http_header_val_t *hv, ngx_str_t *value);
ngx_int_t ngx_http_add_header(ngx_http_request_t *r,
    ngx_http_header_val_t *hv, ngx_str_t *value);
...
char *ngx_http_headers_merge_conf(ngx_conf_t *cf,
...
static ngx_http_module_t  ngx_http_headers_filter_module_ctx = {
    ...
    postconfiguration_ngx_http_headers_filter_init,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_headers_create_conf,
    merge_loc_conf_ngx_http_headers_merge_conf
};
