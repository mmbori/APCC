...
ngx_int_t ngx_http_fastcgi_body_output_filter(void *data,
    ngx_chain_t *in);
ngx_int_t ngx_http_fastcgi_process_header(ngx_http_request_t *r);
ngx_int_t ngx_http_fastcgi_input_filter_init(void *data);
ngx_int_t ngx_http_fastcgi_input_filter(ngx_event_pipe_t *p,
    ngx_buf_t *buf);
ngx_int_t ngx_http_fastcgi_non_buffered_filter(void *data,
    ssize_t bytes);
...
void ngx_http_fastcgi_finalize_request(ngx_http_request_t *r,
    ngx_int_t rc);
...
char *ngx_http_fastcgi_merge_loc_conf(ngx_conf_t *cf,
...
static ngx_http_module_t  ngx_http_fastcgi_module_ctx = {
    ...
    ,
    preconfiguration_ngx_http_fastcgi_add_variables,
    postconfiguration_NULL,
    create_main_conf_ngx_http_fastcgi_create_main_conf,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_fastcgi_create_loc_conf,
    merge_loc_conf_ngx_http_fastcgi_merge_loc_conf
};
