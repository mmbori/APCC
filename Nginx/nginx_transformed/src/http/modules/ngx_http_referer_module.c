...
char * ngx_http_referer_merge_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static ngx_http_module_t  ngx_http_referer_module_ctx = {
    ...
    ,
    preconfiguration_ngx_http_referer_add_variables,
    postconfiguration_NULL,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_referer_create_conf,
    merge_loc_conf_ngx_http_referer_merge_conf
};
