...
char *ngx_http_userid_merge_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static ngx_http_module_t  ngx_http_userid_filter_module_ctx = {
    ...
    ,
    preconfiguration_ngx_http_userid_add_variables,
    postconfiguration_ngx_http_userid_init,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_userid_create_conf,
    merge_loc_conf_ngx_http_userid_merge_conf
};
...
ngx_module_t  ngx_http_userid_filter_module = {
    ...
    init_master_NULL,
    init_module_NULL,
    init_process_ngx_http_userid_init_worker,
    init_thread_NULL, 
    exit_thread_NULL,
    exit_process_NULL,
    exit_master_NULL
