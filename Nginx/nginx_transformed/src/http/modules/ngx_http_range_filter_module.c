...
static ngx_http_module_t  ngx_http_range_header_filter_module_ctx = {
    ...
    postconfiguration_ngx_http_range_header_filter_init,
...
static ngx_http_module_t  ngx_http_range_body_filter_module_ctx = {
    ...
    preconfiguration_NULL,
    postconfiguration_ngx_http_range_body_filter_init,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    ...
    ngx_http_range_filter_ctx_t *ctx, ngx_chain_t *in)
{
    ...
    if (ngx_http_next_body_filter == ngx_http_chunked_body_filter) {
            return ngx_http_chunked_body_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_trailers_filter) {
            return ngx_http_trailers_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_ssi_body_filter) {
            return ngx_http_ssi_body_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_copy_filter) {
            return ngx_http_copy_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_postpone_filter) {
            return ngx_http_postpone_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_write_filter) {
            return ngx_http_write_filter(r, out);
        }
        else if (ngx_http_next_body_filter == ngx_http_range_body_filter) {
            return ngx_http_range_body_filter(r, out);
        }
