...
char *ngx_http_auth_basic_merge_loc_conf(ngx_conf_t *cf,
...
static ngx_http_module_t  ngx_http_auth_basic_module_ctx = {
    ...
    postconfiguration_ngx_http_auth_basic_init,
    create_main_conf_NULL,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_auth_basic_create_loc_conf,
    merge_loc_conf_ngx_http_auth_basic_merge_loc_conf
};
