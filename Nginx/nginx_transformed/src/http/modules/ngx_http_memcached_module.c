...
void ngx_http_memcached_finalize_request(ngx_http_request_t *r,
    ngx_int_t rc);

void *ngx_http_memcached_create_loc_conf(ngx_conf_t *cf);
char *ngx_http_memcached_merge_loc_conf(ngx_conf_t *cf,
...
static ngx_http_module_t  ngx_http_memcached_module_ctx = {
    ...
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_memcached_create_loc_conf,
    merge_loc_conf_ngx_http_memcached_merge_loc_conf
};
