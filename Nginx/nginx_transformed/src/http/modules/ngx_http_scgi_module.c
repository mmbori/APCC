...
char *ngx_http_scgi_merge_loc_conf(ngx_conf_t *cf, void *parent,
    void *child);
...
static ngx_http_module_t ngx_http_scgi_module_ctx = {
    ...
    create_main_conf_ngx_http_scgi_create_main_conf,
    init_main_conf_NULL,
    create_srv_conf_NULL,
    merge_srv_conf_NULL,
    create_loc_conf_ngx_http_scgi_create_loc_conf,
    merge_loc_conf_ngx_http_scgi_merge_loc_conf
};
...
ngx_http_scgi_create_request(ngx_http_request_t *r)
{
    ...
    if (params->lengths) {
        ...
        while (*(uintptr_t *) le.ip) {
            ...
            // lcode(&le); /* key length */
            if (lcode == ngx_http_script_copy_len_code) {
            ngx_http_script_copy_len_code(&le);
            }
            else if (lcode == ngx_http_script_copy_var_len_code) {
                ngx_http_script_copy_var_len_code(&le);
            }
            else if (lcode == ngx_http_script_full_name_len_code) {
                ngx_http_script_full_name_len_code(&le);
            }
