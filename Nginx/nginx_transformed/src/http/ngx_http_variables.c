...
ngx_http_get_indexed_variable(ngx_http_request_t *r, ngx_uint_t index)
{
    ...
    int tmp;
    if (v[index].get_handler_signature == get_handler_NULL) {
    tmp = NULL;
}
else if (v[index].get_handler_signature == get_handler_ngx_http_geo_cidr_variable) {
    tmp = ngx_http_geo_cidr_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_geo_range_variable) {
    tmp = ngx_http_geo_range_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_map_variable) {
    tmp = ngx_http_map_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_referer_variable) {
    tmp = ngx_http_referer_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_split_clients_variable) {
    tmp = ngx_http_split_clients_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_userid_got_variable) {
    tmp = ngx_http_userid_got_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_userid_reset_variable) {
    tmp = ngx_http_userid_reset_variable(r, &r->variables[index], v[index].data);
}
else if (v[index].get_handler_signature == get_handler_ngx_http_userid_set_variable) {
    tmp = ngx_http_userid_set_variable(r, &r->variables[index], v[index].data);
}
// else if (v[index].get_handler_signature == get_handler_ngx_http_variable_not_found) {
//     tmp = ngx_http_variable_not_found(r, &r->variables[index], v[index].data);
// }
...
ngx_http_get_variable(ngx_http_request_t *r, ngx_str_t *name, ngx_uint_t key)
{
    ...
    if (v) {
        ...
        int tmp;
        if (v->get_handler_signature == get_handler_NULL) {
    tmp = NULL;
}
else if (v->get_handler_signature == get_handler_ngx_http_geo_cidr_variable) {
    tmp = ngx_http_geo_cidr_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_geo_range_variable) {
    tmp = ngx_http_geo_range_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_map_variable) {
    tmp = ngx_http_map_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_referer_variable) {
    tmp = ngx_http_referer_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_split_clients_variable) {
    tmp = ngx_http_split_clients_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_userid_got_variable) {
    tmp = ngx_http_userid_got_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_userid_reset_variable) {
    tmp = ngx_http_userid_reset_variable(r, vv, v->data);
}
else if (v->get_handler_signature == get_handler_ngx_http_userid_set_variable) {
    tmp = ngx_http_userid_set_variable(r, vv, v->data);
}
// else if (v->get_handler_signature == get_handler_ngx_http_variable_not_found) {
//     tmp = ngx_http_variable_not_found(r, vv, v->data);
// }
    ...
    if (n != cmcf->prefix_variables.nelts) {
        int tmp;
        if (v[n].get_handler_signature == get_handler_NULL) {
    tmp = NULL;
}
else if (v[n].get_handler_signature == get_handler_ngx_http_geo_cidr_variable) {
    tmp = ngx_http_geo_cidr_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_geo_range_variable) {
    tmp = ngx_http_geo_range_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_map_variable) {
    tmp = ngx_http_map_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_referer_variable) {
    tmp = ngx_http_referer_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_split_clients_variable) {
    tmp = ngx_http_split_clients_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_userid_got_variable) {
    tmp = ngx_http_userid_got_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_userid_reset_variable) {
    tmp = ngx_http_userid_reset_variable(r, vv, (uintptr_t) name);
}
else if (v[n].get_handler_signature == get_handler_ngx_http_userid_set_variable) {
    tmp = ngx_http_userid_set_variable(r, vv, (uintptr_t) name);
}
// else if (v[n].get_handler_signature == get_handler_ngx_http_variable_not_found) {
//     tmp = ngx_http_variable_not_found(r, vv, (uintptr_t) name);
// }
