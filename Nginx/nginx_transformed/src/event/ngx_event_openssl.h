...
struct ngx_ssl_connection_s {
    ...
    void (*save_session)(ngx_connection_t *c);

    void (*saved_read_handler)(ngx_event_t *ev);
    void (*saved_write_handler)(ngx_event_t *ev);
    ...
    int saved_read_handler_signature;
    int saved_write_handler_signature;
};
...
typedef struct {
    int (*servername)(ngx_ssl_conn_t *, int *, void *);
