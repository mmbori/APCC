...
typedef struct {
    ...
    int manager_signature;
    int purger_signature;
    int loader_signature;
} ngx_path_t;
...
struct ngx_tree_ctx_s {
    ...
    int init_handler_signature;
    int file_handler_signature;
    int pre_tree_handler_signature;
    int post_tree_handler_signature;
    int spec_handler_signature;
};
