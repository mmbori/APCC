    ...
    for ( ;; ) {
        ...
        *p++ = '/';
        ...
        if (ngx_de_is_file(&dir)) {
            ...
            if (ngx_http_file_cache_manage_file(ctx, &file) == NGX_ABORT) {
                goto failed;
            }
            ...
            rc = ngx_http_file_cache_manage_directory(ctx, &file);
            ...
            if (ngx_http_file_cache_noop(ctx, &file) == NGX_ABORT) {
                goto failed;
            }
            ...
            if (ngx_http_file_cache_delete_file(ctx, &file) == NGX_ABORT) {
                goto failed;
            }
        }
    }
