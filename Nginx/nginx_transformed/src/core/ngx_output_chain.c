...
ngx_output_chain(ngx_output_chain_ctx_t *ctx, ngx_chain_t *in)
{
       ...
       )
    {
        ...
        if (in == NULL) {
            ...
            if (ctx->output_filter_signature == output_filter_ngx_chain_writer) {
                return ngx_chain_writer(ctx->filter_ctx, in);
            }
            else if (ctx->output_filter_signature == output_filter_ngx_http_fastcgi_body_output_filter) {
                return ngx_http_fastcgi_body_output_filter(ctx->filter_ctx, in);
            }
            else if (ctx->output_filter_signature == output_filter_ngx_http_proxy_body_output_filter) {
                return ngx_http_proxy_body_output_filter(ctx->filter_ctx, in);
            }
            else if (ctx->output_filter_signature == output_filter_ngx_http_upstream_output_filter) {
                return ngx_http_upstream_output_filter(ctx->filter_ctx, in);
            }
        }
    ...
    for ( ;; ) {
        ...
        // if (ctx->output_filter_signature == output_filter_ngx_chain_writer) {
        //         last = ngx_chain_writer(ctx->filter_ctx, out);
        //     }
        //     else if (ctx->output_filter_signature == output_filter_ngx_http_fastcgi_body_output_filter) {
        //         last = ngx_http_fastcgi_body_output_filter(ctx->filter_ctx, out);
        //     }
        //     else if (ctx->output_filter_signature == output_filter_ngx_http_proxy_body_output_filter) {
        //         last = ngx_http_proxy_body_output_filter(ctx->filter_ctx, out);
        //     }
        //     else if (ctx->output_filter_signature == output_filter_ngx_http_upstream_output_filter) {
        //         last = ngx_http_upstream_output_filter(ctx->filter_ctx, out);
        //     }
...
ngx_chain_writer(void *data, ngx_chain_t *in)
{
    ...
    chain = ngx_linux_sendfile_chain(c, ctx->out, ctx->limit);
