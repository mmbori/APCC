...
struct ngx_module_s {
    ...
    int init_master_signature;
    int init_module_signature;
    int init_process_signature;
    int init_thread_signature;
    int exit_thread_signature;
    int exit_process_signature;
    int exit_master_signature;
};
...
typedef struct {
    ...
    int create_conf_signature;
    int init_conf_signature;
} ngx_core_module_t;
