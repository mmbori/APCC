...
sf_count_t mpeg_l3_encode_write_short_stereo(SF_PRIVATE *psf,
					     const short *ptr, sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_int_stereo(SF_PRIVATE *psf, const int *ptr,
					   sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_float_stereo(SF_PRIVATE *psf,
					     const float *ptr, sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_double_stereo(SF_PRIVATE *psf,
					      const double *ptr,
					      sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_short_mono(SF_PRIVATE *psf, const short *ptr,
					   sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_int_mono(SF_PRIVATE *psf, const int *ptr,
					 sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_float_mono(SF_PRIVATE *psf, const float *ptr,
					   sf_count_t len) ;
sf_count_t mpeg_l3_encode_write_double_mono(SF_PRIVATE *psf,
					    const double *ptr, sf_count_t len) ;
...
{	MPEG_L3_ENC_PRIVATE* pmpeg = NULL ;
	...
	psf->codec_close_signature = codec_close_mpeg_l3_encoder_close; /* Set psf->codec_close early*/
	...
	psf->write_short_signature = write_short_mpeg_l3_encode_write_short_stereo;
		psf->write_int = mpeg_l3_encode_write_int_stereo;
		psf->write_int_signature = write_int_mpeg_l3_encode_write_int_stereo;
		psf->write_float = mpeg_l3_encode_write_float_stereo;
		psf->write_float_signature = write_float_mpeg_l3_encode_write_float_stereo;
		psf->write_double = mpeg_l3_encode_write_double_stereo;
		psf->write_double_signature = write_double_mpeg_l3_encode_write_double_stereo;
		}
	else
	{	psf->write_short = mpeg_l3_encode_write_short_mono;
	psf->write_short_signature = write_short_mpeg_l3_encode_write_short_mono;
		psf->write_int = mpeg_l3_encode_write_int_mono;
		psf->write_int_signature = write_int_mpeg_l3_encode_write_int_mono;
		psf->write_float = mpeg_l3_encode_write_float_mono;
		psf->write_float_signature = write_float_mpeg_l3_encode_write_float_mono;
		psf->write_double = mpeg_l3_encode_write_double_mono;
		psf->write_double_signature = write_double_mpeg_l3_encode_write_double_mono;
		}

	psf->sf.seekable	= 0 ;
	psf->byterate = mpeg_l3_encoder_byterate;
	psf->byterate_signature = byterate_mpeg_l3_encoder_byterate;
	psf->datalength		= 0 ;
