...
# 	define	FILTER	Short_term_analysis_filtering
	...
	// FILTER (S, LARp, 13, s) ;
	if (S->fast) {
		Fast_Short_term_analysis_filtering (S, LARp, 13, s) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_analysis_filtering (S, LARp, 14, s + 13) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_analysis_filtering (S, LARp, 13, s + 27) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_analysis_filtering (S, LARp, 120, s + 40) ;
	}
	else {
...
#	define	FILTER	Short_term_synthesis_filtering
	...
	if (S->fast) {
		Fast_Short_term_synthesis_filtering (S, LARp, 13, wt, s) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_synthesis_filtering (S, LARp, 14, wt + 13, s + 13) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_synthesis_filtering (S, LARp, 13, wt + 27, s + 27) ;
	}
	else {
	...
	if (S->fast) {
		Fast_Short_term_synthesis_filtering (S, LARp, 120, wt + 40, s + 40) ;
	}
	else {
