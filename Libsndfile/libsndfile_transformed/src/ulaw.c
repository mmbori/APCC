...
sf_count_t ulaw_write_s2ulaw(SF_PRIVATE *psf, const short *ptr,
			     sf_count_t len) ;
sf_count_t ulaw_write_i2ulaw(SF_PRIVATE *psf, const int *ptr, sf_count_t len) ;
sf_count_t ulaw_write_f2ulaw(SF_PRIVATE *psf, const float *ptr,
			     sf_count_t len) ;
sf_count_t ulaw_write_d2ulaw(SF_PRIVATE *psf, const double *ptr,
			     sf_count_t len) ;
...
ulaw_init (SF_PRIVATE *psf)
{
	...
	psf->read_short_signature = read_short_ulaw_read_ulaw2s;
		psf->read_int = ulaw_read_ulaw2i;
		psf->read_int_signature = read_int_ulaw_read_ulaw2i;
		psf->read_float = ulaw_read_ulaw2f;
		psf->read_float_signature = read_float_ulaw_read_ulaw2f;
		psf->read_double = ulaw_read_ulaw2d;
		psf->read_double_signature = read_double_ulaw_read_ulaw2d;
		} ;

	if (psf->file.mode == SFM_WRITE || psf->file.mode == SFM_RDWR)
	{	psf->write_short = ulaw_write_s2ulaw;
	psf->write_short_signature = write_short_ulaw_write_s2ulaw;
		psf->write_int = ulaw_write_i2ulaw;
		psf->write_int_signature = write_int_ulaw_write_i2ulaw;
		psf->write_float = ulaw_write_f2ulaw;
		psf->write_float_signature = write_float_ulaw_write_f2ulaw;
		psf->write_double = ulaw_write_d2ulaw;
		psf->write_double_signature = write_double_ulaw_write_d2ulaw;
		} ;
