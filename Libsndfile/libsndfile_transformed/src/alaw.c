...
sf_count_t alaw_write_s2alaw(SF_PRIVATE *psf, const short *ptr,
			     sf_count_t len) ;
sf_count_t alaw_write_i2alaw(SF_PRIVATE *psf, const int *ptr, sf_count_t len) ;
sf_count_t alaw_write_f2alaw(SF_PRIVATE *psf, const float *ptr,
			     sf_count_t len) ;
sf_count_t alaw_write_d2alaw(SF_PRIVATE *psf, const double *ptr,
			     sf_count_t len) ;
...
alaw_init (SF_PRIVATE *psf)
{
	...
	psf->read_short_signature = read_short_alaw_read_alaw2s;
		psf->read_int = alaw_read_alaw2i;
		psf->read_int_signature = read_int_alaw_read_alaw2i;
		psf->read_float = alaw_read_alaw2f;
		psf->read_float_signature = read_float_alaw_read_alaw2f;
		psf->read_double = alaw_read_alaw2d;
		psf->read_double_signature = read_double_alaw_read_alaw2d;
		} ;

	if (psf->file.mode == SFM_WRITE || psf->file.mode == SFM_RDWR)
	{	psf->write_short = alaw_write_s2alaw;
	psf->write_short_signature = write_short_alaw_write_s2alaw;
		psf->write_int = alaw_write_i2alaw;
		psf->write_int_signature = write_int_alaw_write_i2alaw;
		psf->write_float = alaw_write_f2alaw;
		psf->write_float_signature = write_float_alaw_write_f2alaw;
		psf->write_double = alaw_write_d2alaw;
		psf->write_double_signature = write_double_alaw_write_d2alaw;
		} ;
