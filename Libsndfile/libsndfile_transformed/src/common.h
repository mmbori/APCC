...
typedef struct sf_private_tag
{
	...
	*/
	...
	int seek_signature;
	int write_header_signature;
	int command_signature;
	int byterate_signature;
	int codec_close_signature;
	int container_close_signature;
	int set_chunk_signature;
	int next_chunk_iterator_signature;
	int get_chunk_size_signature;
	int get_chunk_data_signature;
} SF_PRIVATE ;
