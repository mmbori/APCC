...
// 	if (psf->virtual_io) {
// 		switch (psf->vio.seek_signature) {
// 		case seek_aiff_ima_seek:
// 		    return aiff_ima_seek(offset, whence, psf->vio_user_data);
// 		case seek_alac_seek:
// 		    return alac_seek(offset, whence, psf->vio_user_data);
// 		case seek_dpcm_seek:
// 		    return dpcm_seek(offset, whence, psf->vio_user_data);
// 		case seek_dwvw_seek:
// 		    return dwvw_seek(offset, whence, psf->vio_user_data);
// 		case seek_g72x_seek:
// 		    return g72x_seek(offset, whence, psf->vio_user_data);
// 		case seek_gsm610_seek:
// 		    return gsm610_seek(offset, whence, psf->vio_user_data);
// 		case seek_interleave_seek:
// 		    return interleave_seek(offset, whence, psf->vio_user_data);
// 		case seek_msadpcm_seek:
// 		    return msadpcm_seek(offset, whence, psf->vio_user_data);
// 		case seek_nms_adpcm_seek:
// 		    return nms_adpcm_seek(offset, whence, psf->vio_user_data);
// 		case seek_paf24_seek:
// 		    return paf24_seek(offset, whence, psf->vio_user_data);
// 		case seek_psf_default_seek:
// 		    return psf_default_seek(offset, whence, psf->vio_user_data);
// 		case seek_sds_seek:
// 		    return sds_seek(offset, whence, psf->vio_user_data);
// 		case seek_wavlike_ima_seek:
// 		    return wavlike_ima_seek(offset, whence, psf->vio_user_data);
// 		default:
