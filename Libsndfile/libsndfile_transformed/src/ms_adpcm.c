...
{	MSADPCM_PRIVATE	*pms ;
	...
	{	pms->dataremaining = psf->datalength ;
		...
		psf->read_short_signature = read_short_msadpcm_read_s;
		psf->read_int = msadpcm_read_i;
		psf->read_int_signature = read_int_msadpcm_read_i;
		psf->read_float = msadpcm_read_f;
		psf->read_float_signature = read_float_msadpcm_read_f;
		psf->read_double = msadpcm_read_d;
		psf->read_double_signature = read_double_msadpcm_read_d;
		} ;
	...
	{	pms->samples = pms->dummydata ;
		...
		psf->write_short_signature = write_short_msadpcm_write_s;
		psf->write_int = msadpcm_write_i;
		psf->write_int_signature = write_int_msadpcm_write_i;
		psf->write_float = msadpcm_write_f;
		psf->write_float_signature = write_float_msadpcm_write_f;
		psf->write_double = msadpcm_write_d;
		psf->write_double_signature = write_double_msadpcm_write_d;
		} ;

	psf->codec_close = msadpcm_close;
	psf->codec_close_signature = codec_close_msadpcm_close;
	psf->seek = msadpcm_seek;
	psf->seek_signature = seek_msadpcm_seek;
