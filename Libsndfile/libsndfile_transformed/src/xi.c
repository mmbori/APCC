...
{	XI_PRIVATE *pxi ;
	...
	{	if ((SF_CONTAINER (psf->sf.format)) != SF_FORMAT_XI)
		...
		psf->write_header_signature = write_header_xi_write_header;
		} ;

	psf->container_close = xi_close;
	psf->container_close_signature = container_close_xi_close;
	psf->seek = dpcm_seek;
	psf->seek_signature = seek_dpcm_seek;
...
int xi_close(SF_PRIVATE * UNUSED(psf))
{
	return 0 ;
} /* xi_close */
...
sf_count_t dpcm_write_d2dsc(SF_PRIVATE *psf, const double *ptr,
			    sf_count_t len);
...
sf_count_t dpcm_write_s2dles(SF_PRIVATE *psf, const short *ptr,
			     sf_count_t len);
sf_count_t dpcm_write_i2dles(SF_PRIVATE *psf, const int *ptr, sf_count_t len);
sf_count_t dpcm_write_f2dles(SF_PRIVATE *psf, const float *ptr,
			     sf_count_t len);
sf_count_t dpcm_write_d2dles(SF_PRIVATE *psf, const double *ptr,
			     sf_count_t len);
...
{	if (psf->bytewidth == 0 || psf->sf.channels == 0)
	...
	{	switch (psf->bytewidth)
		{	case 1 :
					...
					psf->read_short_signature = read_short_dpcm_read_dsc2s;
					psf->read_int = dpcm_read_dsc2i;
					psf->read_int_signature = read_int_dpcm_read_dsc2i;
					psf->read_float = dpcm_read_dsc2f;
					psf->read_float_signature = read_float_dpcm_read_dsc2f;
					psf->read_double = dpcm_read_dsc2d;
					psf->read_double_signature = read_double_dpcm_read_dsc2d;
					break ;
			case 2 :
					psf->read_short = dpcm_read_dles2s;
					psf->read_short_signature = read_short_dpcm_read_dles2s;
					psf->read_int = dpcm_read_dles2i;
					psf->read_int_signature = read_int_dpcm_read_dles2i;
					psf->read_float = dpcm_read_dles2f;
					psf->read_float_signature = read_float_dpcm_read_dles2f;
					psf->read_double = dpcm_read_dles2d;
					psf->read_double_signature = read_double_dpcm_read_dles2d;
					break ;
			default :
	...
	{	switch (psf->bytewidth)
		{	case 1 :
					...
					psf->write_short_signature = write_short_dpcm_write_s2dsc;
					psf->write_int = dpcm_write_i2dsc;
					psf->write_int_signature = write_int_dpcm_write_i2dsc;
					psf->write_float = dpcm_write_f2dsc;
					psf->write_float_signature = write_float_dpcm_write_f2dsc;
					psf->write_double = dpcm_write_d2dsc;
					psf->write_double_signature = write_double_dpcm_write_d2dsc;
					break ;
			case 2 :
					psf->write_short = dpcm_write_s2dles;
					psf->write_short_signature = write_short_dpcm_write_s2dles;
					psf->write_int = dpcm_write_i2dles;
					psf->write_int_signature = write_int_dpcm_write_i2dles;
					psf->write_float = dpcm_write_f2dles;
					psf->write_float_signature = write_float_dpcm_write_f2dles;
					psf->write_double = dpcm_write_d2dles;
					psf->write_double_signature = write_double_dpcm_write_d2dles;
					break ;
			default :
				psf_log_printf (psf, "dpcm_init() returning SFE_UNIMPLEMENTED\n") ;
				return SFE_UNIMPLEMENTED ;
