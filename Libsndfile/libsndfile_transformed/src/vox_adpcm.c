...
{	IMA_OKI_ADPCM *pvox = NULL ;
	...
	psf->write_short_signature = write_short_vox_write_s;
		psf->write_int = vox_write_i;
		psf->write_int_signature = write_int_vox_write_i;
		psf->write_float = vox_write_f;
		psf->write_float_signature = write_float_vox_write_f;
		psf->write_double = vox_write_d;
		psf->write_double_signature = write_double_vox_write_d;
		}
	else
	{	psf_log_printf (psf, "Header-less OKI Dialogic ADPCM encoded file.\n") ;
		...
		psf->read_short_signature = read_short_vox_read_s;
		psf->read_int = vox_read_i;
		psf->read_int_signature = read_int_vox_read_i;
		psf->read_float = vox_read_f;
		psf->read_float_signature = read_float_vox_read_f;
		psf->read_double = vox_read_d;
		psf->read_double_signature = read_double_vox_read_d;
		} ;
