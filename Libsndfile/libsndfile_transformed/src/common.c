...
{	sf_count_t count, readlen, total = 0 ;
	...
	case read_int_alac_read_i:
	    count = alac_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_alaw_read_alaw2i:
	    count = alaw_read_alaw2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_dither_read_int:
	    count = dither_read_int(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_dpcm_read_dles2i:
	    count = dpcm_read_dles2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_dpcm_read_dsc2i:
	    count = dpcm_read_dsc2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_dwvw_read_i:
	    count = dwvw_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_g72x_read_i:
	    count = g72x_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_gsm610_read_i:
	    count = gsm610_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_host_read_d2i:
	    count = host_read_d2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_host_read_f2i:
	    count = host_read_f2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_ima_read_i:
	    count = ima_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_interleave_read_int:
	    count = interleave_read_int(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_msadpcm_read_i:
	    count = msadpcm_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_nms_adpcm_read_i:
	    count = nms_adpcm_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_paf24_read_i:
	    count = paf24_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_bei2i:
	    count = pcm_read_bei2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_bes2i:
	    count = pcm_read_bes2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_bet2i:
	    count = pcm_read_bet2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_lei2i:
	    count = pcm_read_lei2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_les2i:
	    count = pcm_read_les2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_let2i:
	    count = pcm_read_let2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_sc2i:
	    count = pcm_read_sc2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_pcm_read_uc2i:
	    count = pcm_read_uc2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_replace_read_d2i:
	    count = replace_read_d2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_replace_read_f2i:
	    count = replace_read_f2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_sds_read_i:
	    count = sds_read_i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_ulaw_read_ulaw2i:
	    count = ulaw_read_ulaw2i(psf, ubuf.ibuf, readlen);
	    break;
	case read_int_vox_read_i:
	    count = vox_read_i(psf, ubuf.ibuf, readlen);
	    break;
	default:
