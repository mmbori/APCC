	...
	{	switch (psf->bytewidth * 0x10000 + psf->endian + chars)
		{	case (0x10000 + SF_ENDIAN_BIG + SF_CHARS_SIGNED) :
			case (0x10000 + SF_ENDIAN_LITTLE + SF_CHARS_SIGNED) :
					...
					psf->read_short_signature = read_short_pcm_read_sc2s;
					psf->read_int = pcm_read_sc2i;
					psf->read_int_signature = read_int_pcm_read_sc2i;
					psf->read_float = pcm_read_sc2f;
					psf->read_float_signature = read_float_pcm_read_sc2f;
					psf->read_double = pcm_read_sc2d;
					psf->read_double_signature = read_double_pcm_read_sc2d;
					break ;
			case (0x10000 + SF_ENDIAN_BIG + SF_CHARS_UNSIGNED) :
			case (0x10000 + SF_ENDIAN_LITTLE + SF_CHARS_UNSIGNED) :
					psf->read_short = pcm_read_uc2s;
					psf->read_short_signature = read_short_pcm_read_uc2s;
					psf->read_int = pcm_read_uc2i;
					psf->read_int_signature = read_int_pcm_read_uc2i;
					psf->read_float = pcm_read_uc2f;
					psf->read_float_signature = read_float_pcm_read_uc2f;
					psf->read_double = pcm_read_uc2d;
					psf->read_double_signature = read_double_pcm_read_uc2d;
					break ;

			case (2 * 0x10000 + SF_ENDIAN_BIG) :
					psf->read_short = pcm_read_bes2s;
					psf->read_short_signature = read_short_pcm_read_bes2s;
					psf->read_int = pcm_read_bes2i;
					psf->read_int_signature = read_int_pcm_read_bes2i;
					psf->read_float = pcm_read_bes2f;
					psf->read_float_signature = read_float_pcm_read_bes2f;
					psf->read_double = pcm_read_bes2d;
					psf->read_double_signature = read_double_pcm_read_bes2d;
					break ;
			case (3 * 0x10000 + SF_ENDIAN_BIG) :
					psf->read_short = pcm_read_bet2s;
					psf->read_short_signature = read_short_pcm_read_bet2s;
					psf->read_int = pcm_read_bet2i;
					psf->read_int_signature = read_int_pcm_read_bet2i;
					psf->read_float = pcm_read_bet2f;
					psf->read_float_signature = read_float_pcm_read_bet2f;
					psf->read_double = pcm_read_bet2d;
					psf->read_double_signature = read_double_pcm_read_bet2d;
					break ;
			case (4 * 0x10000 + SF_ENDIAN_BIG) :

					psf->read_short = pcm_read_bei2s;
					psf->read_short_signature = read_short_pcm_read_bei2s;
					psf->read_int = pcm_read_bei2i;
					psf->read_int_signature = read_int_pcm_read_bei2i;
					psf->read_float = pcm_read_bei2f;
					psf->read_float_signature = read_float_pcm_read_bei2f;
					psf->read_double = pcm_read_bei2d;
					psf->read_double_signature = read_double_pcm_read_bei2d;
					break ;

			case (2 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->read_short = pcm_read_les2s;
					psf->read_short_signature = read_short_pcm_read_les2s;
					psf->read_int = pcm_read_les2i;
					psf->read_int_signature = read_int_pcm_read_les2i;
					psf->read_float = pcm_read_les2f;
					psf->read_float_signature = read_float_pcm_read_les2f;
					psf->read_double = pcm_read_les2d;
					psf->read_double_signature = read_double_pcm_read_les2d;
					break ;
			case (3 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->read_short = pcm_read_let2s;
					psf->read_short_signature = read_short_pcm_read_let2s;
					psf->read_int = pcm_read_let2i;
					psf->read_int_signature = read_int_pcm_read_let2i;
					psf->read_float = pcm_read_let2f;
					psf->read_float_signature = read_float_pcm_read_let2f;
					psf->read_double = pcm_read_let2d;
					psf->read_double_signature = read_double_pcm_read_let2d;
					break ;
			case (4 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->read_short = pcm_read_lei2s;
					psf->read_short_signature = read_short_pcm_read_lei2s;
					psf->read_int = pcm_read_lei2i;
					psf->read_int_signature = read_int_pcm_read_lei2i;
					psf->read_float = pcm_read_lei2f;
					psf->read_float_signature = read_float_pcm_read_lei2f;
					psf->read_double = pcm_read_lei2d;
					psf->read_double_signature = read_double_pcm_read_lei2d;
					break ;
			default :
	...
	{	switch (psf->bytewidth * 0x10000 + psf->endian + chars)
		{	case (0x10000 + SF_ENDIAN_BIG + SF_CHARS_SIGNED) :
			case (0x10000 + SF_ENDIAN_LITTLE + SF_CHARS_SIGNED) :
					...
					psf->write_short_signature = write_short_pcm_write_s2sc;
					psf->write_int = pcm_write_i2sc;
					psf->write_int_signature = write_int_pcm_write_i2sc;
					psf->write_float = pcm_write_f2sc;
					psf->write_float_signature = write_float_pcm_write_f2sc;
					psf->write_double = pcm_write_d2sc;
					psf->write_double_signature = write_double_pcm_write_d2sc;
					break ;
			case (0x10000 + SF_ENDIAN_BIG + SF_CHARS_UNSIGNED) :
			case (0x10000 + SF_ENDIAN_LITTLE + SF_CHARS_UNSIGNED) :
					psf->write_short = pcm_write_s2uc;
					psf->write_short_signature = write_short_pcm_write_s2uc;
					psf->write_int = pcm_write_i2uc;
					psf->write_int_signature = write_int_pcm_write_i2uc;
					psf->write_float = pcm_write_f2uc;
					psf->write_float_signature = write_float_pcm_write_f2uc;
					psf->write_double = pcm_write_d2uc;
					psf->write_double_signature = write_double_pcm_write_d2uc;
					break ;

			case (2 * 0x10000 + SF_ENDIAN_BIG) :
					psf->write_short = pcm_write_s2bes;
					psf->write_short_signature = write_short_pcm_write_s2bes;
					psf->write_int = pcm_write_i2bes;
					psf->write_int_signature = write_int_pcm_write_i2bes;
					psf->write_float = pcm_write_f2bes;
					psf->write_float_signature = write_float_pcm_write_f2bes;
					psf->write_double = pcm_write_d2bes;
					psf->write_double_signature = write_double_pcm_write_d2bes;
					break ;

			case (3 * 0x10000 + SF_ENDIAN_BIG) :
					psf->write_short = pcm_write_s2bet;
					psf->write_short_signature = write_short_pcm_write_s2bet;
					psf->write_int = pcm_write_i2bet;
					psf->write_int_signature = write_int_pcm_write_i2bet;
					psf->write_float = pcm_write_f2bet;
					psf->write_float_signature = write_float_pcm_write_f2bet;
					psf->write_double = pcm_write_d2bet;
					psf->write_double_signature = write_double_pcm_write_d2bet;
					break ;

			case (4 * 0x10000 + SF_ENDIAN_BIG) :
					psf->write_short = pcm_write_s2bei;
					psf->write_short_signature = write_short_pcm_write_s2bei;
					psf->write_int = pcm_write_i2bei;
					psf->write_int_signature = write_int_pcm_write_i2bei;
					psf->write_float = pcm_write_f2bei;
					psf->write_float_signature = write_float_pcm_write_f2bei;
					psf->write_double = pcm_write_d2bei;
					psf->write_double_signature = write_double_pcm_write_d2bei;
					break ;

			case (2 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->write_short = pcm_write_s2les;
					psf->write_short_signature = write_short_pcm_write_s2les;
					psf->write_int = pcm_write_i2les;
					psf->write_int_signature = write_int_pcm_write_i2les;
					psf->write_float = pcm_write_f2les;
					psf->write_float_signature = write_float_pcm_write_f2les;
					psf->write_double = pcm_write_d2les;
					psf->write_double_signature = write_double_pcm_write_d2les;
					break ;

			case (3 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->write_short = pcm_write_s2let;
					psf->write_short_signature = write_short_pcm_write_s2let;
					psf->write_int = pcm_write_i2let;
					psf->write_int_signature = write_int_pcm_write_i2let;
					psf->write_float = pcm_write_f2let;
					psf->write_float_signature = write_float_pcm_write_f2let;
					psf->write_double = pcm_write_d2let;
					psf->write_double_signature = write_double_pcm_write_d2let;
					break ;

			case (4 * 0x10000 + SF_ENDIAN_LITTLE) :
					psf->write_short = pcm_write_s2lei;
					psf->write_short_signature = write_short_pcm_write_s2lei;
					psf->write_int = pcm_write_i2lei;
					psf->write_int_signature = write_int_pcm_write_i2lei;
					psf->write_float = pcm_write_f2lei;
					psf->write_float_signature = write_float_pcm_write_f2lei;
					psf->write_double = pcm_write_d2lei;
					psf->write_double_signature = write_double_pcm_write_d2lei;
					break ;
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			f2sc_clip_array(ptr + total, ubuf.scbuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2sc_array(ptr + total, ubuf.scbuf, bufferlen, psf->norm_float) ;
		}
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			f2uc_clip_array(ptr + total, ubuf.ucbuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2uc_array(ptr + total, ubuf.ucbuf, bufferlen, psf->norm_float) ;
		}
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			f2bes_clip_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2bes_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.sbuf, sizeof (short), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, ubuf.sbuf, bufferlen, psf->norm_float) ;
		if (psf->add_clipping) {
			f2les_clip_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2les_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.sbuf, sizeof (short), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			f2let_clip_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_float) ;
		}
		else {
			f2let_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.ucbuf, SIZEOF_TRIBYTE, bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_float) ;
		if (psf->add_clipping) {
			f2bet_clip_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_float) ;
		}
		else {
			f2bet_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.ucbuf, SIZEOF_TRIBYTE, bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			f2bei_clip_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2bei_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.ibuf, sizeof (int), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, ubuf.ibuf, bufferlen, psf->norm_float) ;
		if (psf->add_clipping) {
			f2lei_clip_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_float) ;
		}
		else {
			f2lei_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_float) ;
		}
		writecount = (int) psf_fwrite (ubuf.ibuf, sizeof (int), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			d2sc_clip_array (ptr + total, ubuf.scbuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2sc_array (ptr + total, ubuf.scbuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.scbuf, sizeof (signed char), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			d2uc_clip_array (ptr + total, ubuf.ucbuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2uc_array (ptr + total, ubuf.ucbuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.ucbuf, sizeof (unsigned char), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			d2bes_clip_array(ptr + total, ubuf.sbuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2bes_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.sbuf, sizeof (short), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, ubuf.sbuf, bufferlen, psf->norm_double) ;
		if (psf->add_clipping) {
			d2les_clip_array(ptr + total, ubuf.sbuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2les_array (ptr + total, ubuf.sbuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.sbuf, sizeof (short), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			d2let_clip_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_double) ;
		}
		else {
			d2let_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.ucbuf, SIZEOF_TRIBYTE, bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_double) ;
		if (psf->add_clipping) {
			d2bet_clip_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_double) ;
		}
		else {
			d2bet_array (ptr + total, (tribyte*) (ubuf.ucbuf), bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.ucbuf, SIZEOF_TRIBYTE, bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		if (psf->add_clipping) {
			d2bei_clip_array(ptr + total, ubuf.ibuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2bei_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.ibuf, sizeof (int), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ptr + total, ubuf.ibuf, bufferlen, psf->norm_double) ;
		if (psf->add_clipping) {
			d2lei_clip_array(ptr + total, ubuf.ibuf, bufferlen, psf->norm_double) ;
		}
		else {
			d2lei_array (ptr + total, ubuf.ibuf, bufferlen, psf->norm_double) ;
		}
		writecount = (int) psf_fwrite (ubuf.ibuf, sizeof (int), bufferlen, psf) ;
		total += writecount ;
		if (writecount < bufferlen)
