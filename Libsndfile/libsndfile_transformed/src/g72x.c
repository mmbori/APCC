...
{	G72x_PRIVATE	*pg72x ;
	...
	{	pg72x->private = g72x_reader_init (codec, &(pg72x->blocksize), &(pg72x->samplesperblock)) ;
		...
		psf->read_short_signature = read_short_g72x_read_s;
		psf->read_int = g72x_read_i;
		psf->read_int_signature = read_int_g72x_read_i;
		psf->read_float = g72x_read_f;
		psf->read_float_signature = read_float_g72x_read_f;
		psf->read_double = g72x_read_d;
		psf->read_double_signature = read_double_g72x_read_d;

		psf->seek = g72x_seek;
		psf->seek_signature = seek_g72x_seek;
	...
	{	pg72x->private = g72x_writer_init (codec, &(pg72x->blocksize), &(pg72x->samplesperblock)) ;
		...
		psf->write_short_signature = write_short_g72x_write_s;
		psf->write_int = g72x_write_i;
		psf->write_int_signature = write_int_g72x_write_i;
		psf->write_float = g72x_write_f;
		psf->write_float_signature = write_float_g72x_write_f;
		psf->write_double = g72x_write_d;
		psf->write_double_signature = write_double_g72x_write_d;
	...
	psf->codec_close_signature = codec_close_g72x_close;
...
sf_count_t g72x_seek(SF_PRIVATE *psf, int UNUSED(mode),
