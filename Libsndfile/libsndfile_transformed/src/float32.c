...
sf_count_t replace_write_s2f(SF_PRIVATE *psf, const short *ptr,
			     sf_count_t len) ;
...
sf_count_t replace_write_d2f(SF_PRIVATE *psf, const double *ptr,
			     sf_count_t len) ;
...
{	static int float_caps ;
	...
	{	switch (psf->endian + float_caps)
		{	case (SF_ENDIAN_BIG + FLOAT_CAN_RW_BE) :
					...
					psf->read_short_signature = read_short_host_read_f2s;
					psf->read_int = host_read_f2i;
					psf->read_int_signature = read_int_host_read_f2i;
					psf->read_float = host_read_f;
					psf->read_float_signature = read_float_host_read_f;
					psf->read_double = host_read_f2d;
					psf->read_double_signature = read_double_host_read_f2d;
					break ;
			...
			case (SF_ENDIAN_BIG + FLOAT_BROKEN_LE) :
					...
					psf->read_short_signature = read_short_replace_read_f2s;
					psf->read_int = replace_read_f2i;
					psf->read_int_signature = read_int_replace_read_f2i;
					psf->read_float = replace_read_f;
					psf->read_float_signature = read_float_replace_read_f;
					psf->read_double = replace_read_f2d;
					psf->read_double_signature = read_double_replace_read_f2d;
					break ;
	...
	{	switch (psf->endian + float_caps)
		{	case (SF_ENDIAN_LITTLE + FLOAT_CAN_RW_LE) :
					...
					psf->write_short_signature = write_short_host_write_s2f;
					psf->write_int = host_write_i2f;
					psf->write_int_signature = write_int_host_write_i2f;
					psf->write_float = host_write_f;
					psf->write_float_signature = write_float_host_write_f;
					psf->write_double = host_write_d2f;
					psf->write_double_signature = write_double_host_write_d2f;
					break ;
			...
			case (SF_ENDIAN_BIG + FLOAT_BROKEN_LE) :
					...
					psf->write_short_signature = write_short_replace_write_s2f;
					psf->write_int = replace_write_i2f;
					psf->write_int_signature = write_int_replace_write_i2f;
					psf->write_float = replace_write_f;
					psf->write_float_signature = write_float_replace_write_f;
					psf->write_double = replace_write_d2f;
					psf->write_double_signature = write_double_replace_write_d2f;
					break ;
...
/* Fix me : Need lef2s_array */
		...
		if (psf->add_clipping) {
			f2s_clip_array (ubuf.fbuf, readcount, ptr + total, scale) ;
		}
		else {
...
{	BUF_UNION	ubuf ;
	...
	{	if (len < bufferlen)
		...
		// convert (ubuf.fbuf, readcount, ptr + total, scale) ;
		if (psf->add_clipping) {
			f2i_clip_array (ubuf.fbuf, readcount, ptr + total, scale) ;
		}
		else {
