...
#include "../libsndfile_signatures.h"
...
{	G72x_STATE *pstate ;
	...
	{	case G723_16_BITS_PER_SAMPLE : /* 2 bits per sample. */
				...
				pstate->decoder_signature = decoder_g723_16_decoder;
		...
		case G723_24_BITS_PER_SAMPLE : /* 3 bits per sample. */
				...
				pstate->decoder_signature = decoder_g723_24_decoder;
		...
		case G721_32_BITS_PER_SAMPLE : /* 4 bits per sample. */
				...
				pstate->decoder_signature = decoder_g721_decoder;
		...
		case G721_40_BITS_PER_SAMPLE : /* 5 bits per sample. */
				...
				pstate->decoder_signature = decoder_g723_40_decoder;
...
{	G72x_STATE *pstate ;
	...
	{	case G723_16_BITS_PER_SAMPLE : /* 2 bits per sample. */
				...
				pstate->encoder_signature = encoder_g723_16_encoder;
				*blocksize = G723_16_BYTES_PER_BLOCK ;
				*samplesperblock = G723_16_SAMPLES_PER_BLOCK ;
				pstate->codec_bits = 2 ;
				pstate->blocksize = G723_16_BYTES_PER_BLOCK ;
		...
		case G723_24_BITS_PER_SAMPLE : /* 3 bits per sample. */
				...
				pstate->encoder_signature = encoder_g723_24_encoder;
				*blocksize = G723_24_BYTES_PER_BLOCK ;
				*samplesperblock = G723_24_SAMPLES_PER_BLOCK ;
				pstate->codec_bits = 3 ;
				pstate->blocksize = G723_24_BYTES_PER_BLOCK ;
		...
		case G721_32_BITS_PER_SAMPLE : /* 4 bits per sample. */
				...
				pstate->encoder_signature = encoder_g721_encoder;
				*blocksize = G721_32_BYTES_PER_BLOCK ;
				*samplesperblock = G721_32_SAMPLES_PER_BLOCK ;
				pstate->codec_bits = 4 ;
				pstate->blocksize = G721_32_BYTES_PER_BLOCK ;
		...
		case G721_40_BITS_PER_SAMPLE : /* 5 bits per sample. */
				...
				pstate->encoder_signature = encoder_g723_40_encoder;
				*blocksize = G721_40_BYTES_PER_BLOCK ;
				*samplesperblock = G721_40_SAMPLES_PER_BLOCK ;
				pstate->codec_bits = 5 ;
				pstate->blocksize = G721_40_BYTES_PER_BLOCK ;
...
{	int	k, count ;
	...
	for (k = 0 ; k < count ; k++) {
		...
		// switch (pstate->decoder_signature) {
		// 	case decoder_g721_decoder:
		// 		samples [k] = g721_decoder(samples [k], pstate) ;
		// 	case decoder_g723_16_decoder:
		// 		samples [k] = g723_16_decoder(samples [k], pstate) ;
		// 	case decoder_g723_24_decoder:
		// 		samples [k] = g723_24_decoder(samples [k], pstate) ;
		// 	case decoder_g723_40_decoder:
		// 		samples [k] = g723_40_decoder(samples [k], pstate) ;
		// 	default:
...
{	int k, count ;
	...
	for (k = 0 ; k < pstate->samplesperblock ; k++) {
		...
		// switch (pstate->encoder_signature) {
		// 	case encoder_g721_encoder:
		// 		samples [k] = g721_encoder(samples [k], pstate) ;
		// 	case encoder_g723_16_encoder:
		// 		samples [k] = g723_16_encoder(samples [k], pstate) ;
		// 	case encoder_g723_24_encoder:
		// 		samples [k] = g723_24_encoder(samples [k], pstate) ;
		// 	case encoder_g723_40_encoder:
		// 		samples [k] = g723_40_encoder(samples [k], pstate) ;
		// 	default:
		// 		invalidFunctionWasCalled();
		// }
	}
