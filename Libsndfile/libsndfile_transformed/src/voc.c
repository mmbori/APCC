...
{	int subformat, error = 0 ;
	...
	{	if ((SF_CONTAINER (psf->sf.format)) != SF_FORMAT_VOC)
		...
		psf->write_header_signature = write_header_voc_write_header;
		} ;

	psf->blockwidth = psf->bytewidth * psf->sf.channels ;

	psf->container_close = voc_close;
	psf->container_close_signature = container_close_voc_close;
...
voc_multi_init (SF_PRIVATE *psf, VOC_DATA *pvoc)
{
	...
	psf->read_short_signature = read_short_voc_multi_read_uc2s;
		psf->read_int = voc_multi_read_uc2i;
		psf->read_int_signature = read_int_voc_multi_read_uc2i;
		psf->read_float = voc_multi_read_uc2f;
		psf->read_float_signature = read_float_voc_multi_read_uc2f;
		psf->read_double = voc_multi_read_uc2d;
		psf->read_double_signature = read_double_voc_multi_read_uc2d;
		return 0 ;
		} ;

	if (pvoc->bitwidth == 16)
	{	psf->read_short = voc_multi_read_les2s;
	psf->read_short_signature = read_short_voc_multi_read_les2s;
		psf->read_int = voc_multi_read_les2i;
		psf->read_int_signature = read_int_voc_multi_read_les2i;
		psf->read_float = voc_multi_read_les2f;
		psf->read_float_signature = read_float_voc_multi_read_les2f;
		psf->read_double = voc_multi_read_les2d;
		psf->read_double_signature = read_double_voc_multi_read_les2d;
		return 0 ;
		} ;
