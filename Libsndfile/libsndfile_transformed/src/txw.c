...
{	int error ;
	...
	psf->read_short_signature = read_short_txw_read_s;
	psf->read_int = txw_read_i;
	psf->read_int_signature = read_int_txw_read_i;
	psf->read_float = txw_read_f;
	psf->read_float_signature = read_float_txw_read_f;
	psf->read_double = txw_read_d;
	psf->read_double_signature = read_double_txw_read_d;

	psf->seek = txw_seek;
	psf->seek_signature = seek_txw_seek;
