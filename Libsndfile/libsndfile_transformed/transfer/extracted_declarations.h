...
int aiff_command(SF_PRIVATE *psf , int command , void *UNUSED ( data ) , int UNUSED ( datasize ));
...
int caf_command(SF_PRIVATE *psf , int command , void *UNUSED ( data ) , int UNUSED ( datasize ));
...
sf_count_t dither_read_int(SF_PRIVATE *UNUSED ( psf ) , int *UNUSED ( ptr ) , sf_count_t len);
sf_count_t dither_read_short(SF_PRIVATE *UNUSED ( psf ) , short *UNUSED ( ptr ) , sf_count_t len);
...
sf_count_t g72x_seek(SF_PRIVATE *psf , int UNUSED ( mode ) , sf_count_t UNUSED ( offset ));
...
sf_count_t interleave_seek(SF_PRIVATE *UNUSED ( psf ) , int UNUSED ( mode ) , sf_count_t samples_from_start);
...
int vorbis_rnull(SF_PRIVATE *UNUSED ( psf ) , int samples , void *UNUSED ( vptr ) , int UNUSED ( off ) , int channels , float **UNUSED ( pcm ));
...
int wav_command(SF_PRIVATE *psf , int command , void *UNUSED ( data ) , int datasize);
