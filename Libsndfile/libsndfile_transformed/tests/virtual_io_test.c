...
{	static VIO_DATA vio_data ;
	...
	vio.get_filelen_signature = get_filelen_vfget_filelen;
	vio.seek = vfseek;
	vio.seek_signature = seek_vfseek;
	vio.read = vfread;
	vio.read_signature = read_vfread;
	vio.write = vfwrite;
	vio.write_signature = write_vfwrite;
	vio.tell = vftell;
	vio.tell_signature = tell_vftell;
