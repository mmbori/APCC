...
void _logger_log_text(logentry *e, const entry_details *d, const void *entry, va_list ap) {
    int reqlen = d->reqlen;
...
void _logger_log_evictions(logentry *e, const entry_details *d, const void *entry, va_list ap) {
    item *it = (item *)entry;
...
#ifdef EXTSTORE
void _logger_log_ext_write(logentry *e, const entry_details *d, const void *entry, va_list ap) {
    item *it = (item *)entry;
...
void _logger_log_item_get(logentry *e, const entry_details *d, const void *entry, va_list ap) {
...
void _logger_log_item_store(logentry *e, const entry_details *d, const void *entry, va_list ap) {
...
void _logger_log_item_deleted(logentry *e, const entry_details *d, const void *entry, va_list ap) {
    item *it = (item *)entry;
    int comm = va_arg(ap, int);
...
void _logger_log_conn_event(logentry *e, const entry_details *d, const void *entry, va_list ap) {
...
// here.
void _logger_log_proxy_req(logentry *e, const entry_details *d, const void *entry, va_list ap) {
...
void _logger_log_proxy_errbe(logentry *e, const entry_details *d, const void *entry, va_list ap) {
            ...
            if (watchers_pollfds[nfd].revents & (POLLHUP|POLLERR)) {
                ...
                switch (w->t) {
                    ...
                    case LOGGER_WATCHER_CLIENT:
                        total = tcp_write(w->c, data, data_size);
                        break;
                }
