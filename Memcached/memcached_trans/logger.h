...
struct _entry_details {
    int reqlen;
    uint16_t eflags;
    void (*log_cb)(logentry *e, const entry_details *d, const void *entry, va_list ap);
    int (*parse_cb)(logentry *e, char *scratch);
    char *format;

    int log_cb_signature;
    int parse_cb_signature;
};
